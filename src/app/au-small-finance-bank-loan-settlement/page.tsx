...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'au bank personal loan settlement process',
    'au small finance bank ots policy',
    'au bank sarb settlement negotiation',
    'au bank recovery agent harassment complaint',
    'au bank section 25 pssa legal notice',
    'au small finance bank loan settlement percentage',
    'au bank no dues certificate after settlement',
    'au small finance bank nodal officer escalation',
    'au bank arbitration notice response',
    'au small finance bank business loan settlement',
  ],
  alternates: {
    canonical: 'https://settleloans.in/au-small-finance-bank-loan-settlement',
  },
  openGraph: {
    title: 'AU Small Finance Bank Loan Settlement: SARB Rules, Legal Defense & Haircut (2026)',
    ...
    url: 'https://settleloans.in/au-small-finance-bank-loan-settlement',
    siteName: 'SettleLoans',
    images: [
      {
        url: 'https://settleloans.in/images/infographics/au-small-finance-bank-loan-settlement.jpg',
        width: 1200,
        height: 675,
        alt: 'AU Small Finance Bank Loan Settlement Process and OTS Haircut Guide',
      },
    ],
    locale: 'en_IN',
    type: 'article',
  ...
  twitter: {
    ...
    images: ['https://settleloans.in/images/infographics/au-small-finance-bank-loan-settlement.jpg'],
  },
};
...
const jsonLdGraph = {
  ...
  "@graph": [
    {
      "@type": "WebPage",
      "@id": "https://settleloans.in/au-small-finance-bank-loan-settlement#webpage",
      "url": "https://settleloans.in/au-small-finance-bank-loan-settlement",
      "name": "AU Small Finance Bank Loan Settlement: SARB Rules, Legal Defense & Haircut (2026)",
      "description": "Comprehensive guide to AU Small Finance Bank personal and business loan settlement. Learn how to negotiate directly with AU Bank's SARB, stop NACH bounce charges, halt recovery harassment, defend Section 25 PSSA and arbitration notices, and secure up to 55% OTS haircut under RBI rules.",
      "breadcrumb": {
        "@id": "https://settleloans.in/au-small-finance-bank-loan-settlement#breadcrumb"
      },
      "inLanguage": "en-IN",
      "isPartOf": {
        "@type": "WebSite",
    ...
    },
    {
      ...
      "itemListElement": [
        ...
        },
        {
          ...
          "item": "https://settleloans.in/au-small-finance-bank-loan-settlement"
        }
      ]
    },
    {
      "@type": "Article",
      "@id": "https://settleloans.in/au-small-finance-bank-loan-settlement#article",
      "headline": "AU Small Finance Bank Loan Settlement: SARB Negotiation, Legal Defense & Haircut Guide",
      "description": "A comprehensive strategic guide on negotiating One-Time Settlements (OTS) with AU Small Finance Bank Limited, navigating SARB procedures, halting NACH bounce fees, and safeguarding against recovery harassment.",
      "image": "https://settleloans.in/images/infographics/au-small-finance-bank-loan-settlement.jpg",
    ...
    },
    {
      ...
      "@id": "https://settleloans.in/au-small-finance-bank-loan-settlement#service",
      "name": "SettleLoans - AU Small Finance Bank Loan Settlement & Legal Defense",
      "description": "Specialized legal and financial negotiation advisory for settling defaulted AU Small Finance Bank personal loans, business loans, and wheels credit facilities under RBI compromise frameworks with maximum debt waivers and complete harassment protection.",
      "url": "https://settleloans.in/au-small-finance-bank-loan-settlement",
      "image": "https://settleloans.in/images/infographics/au-small-finance-bank-loan-settlement.jpg",
    ...
    {
      "@type": "FAQPage",
      "@id": "https://settleloans.in/au-small-finance-bank-loan-settlement#faq",
      "mainEntity": [
        {
          "@type": "Question",
...
export default function AUSmallFinanceBankLoanSettlementPage() {
  const tocItems = [
    { id: 'understanding-au-bank-defaults', title: '1. SFB Credit Engine & Recovery Architecture' },
    { id: 'au-bank-delinquency-timeline-npa', title: '2. Delinquency Timeline & NPA Stages' },
    { id: 'stopping-au-bank-bounce-charges-nach', title: '3. Halting NACH Bounce Charges & Penal Fees' },
    { id: 'au-bank-ots-haircut-policy-npv', title: '4. OTS Haircut Policies & Valuation Framework' },
    { id: 'infographic-resolution-blueprint', title: '5. Visual Resolution Blueprint' },
    { id: 'sarb-negotiation-recovery-defense', title: '6. SARB Negotiation & Anti-Harassment Defense' },
    { id: 'step-by-step-au-bank-settlement', title: '7. Step-by-Step SFB Settlement Roadmap' },
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <div className="text-xs text-slate-300 border-b border-slate-700 max-w-xl mx-auto pb-3 mb-5 flex flex-wrap items-center justify-center gap-4">
            ...
            <span className="flex items-center gap-1.5">
              ...
              <span>RBI SFB Master Direction Compliant</span>
            </span>
          </div>
          ...
          <div className="flex flex-wrap items-center justify-center gap-3">
            ...
            >
              <span>Negotiate AU Bank Settlement</span>
          ...
          <main className="w-full min-w-0 blog-content">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50/70 border border-blue-200 rounded-2xl p-6 mb-8 shadow-sm">
              <div className="flex items-center gap-2 text-blue-900 font-bold text-base mb-3">
                ...
                <span>Key Takeaways: AU Small Finance Bank Loan Settlement</span>
              </div>
            ...
            {/* Section 1: SFB Credit Engine & Recovery Architecture */}
            <section id="understanding-au-bank-defaults" className="scroll-mt-24 mb-12">
            ...
            <section id="au-bank-delinquency-timeline-npa" className="scroll-mt-24 mb-12">
              <div className="inline-flex items-center gap-2 text-xs font-bold text-[#1F5EFF] uppercase tracking-wider mb-2">
            ...
            <section id="au-bank-ots-haircut-policy-npv" className="scroll-mt-24 mb-12">
              <div className="inline-flex items-center gap-2 text-xs font-bold text-[#1F5EFF] uppercase tracking-wider mb-2">
            ...
            <section id="infographic-resolution-blueprint" className="scroll-mt-24 mb-12">
              <div className="bg-white border-2 border-blue-200 rounded-3xl overflow-hidden shadow-lg my-6 text-slate-800">
                <div className="bg-[#0A2540] text-white py-3.5 px-5 flex items-center justify-between border-b-2 border-[#1F5EFF]">
                  ...
                  <a
                    href="/images/infographics/au-small-finance-bank-loan-settlement.jpg"
                    target="_blank"
                ...
                <div className="p-3 md:p-4 bg-slate-50">
                  <div className="rounded-2xl overflow-hidden border border-slate-200 shadow-sm bg-white">
                    <img
                      src="/images/infographics/au-small-finance-bank-loan-settlement.jpg"
                      alt="AU Small Finance Bank Loan Settlement and OTS Framework Infographic"
            ...
            {/* Section 6: Direct SARB Negotiation vs Recovery Harassment */}
            <section id="sarb-negotiation-recovery-defense" className="scroll-mt-24 mb-12">
              <div className="inline-flex items-center gap-2 text-xs font-bold text-[#1F5EFF] uppercase tracking-wider mb-2">
            ...
            <section id="step-by-step-au-bank-settlement" className="scroll-mt-24 mb-12">
              <div className="inline-flex items-center gap-2 text-xs font-bold text-[#1F5EFF] uppercase tracking-wider mb-2">
              ...
              <ul className="space-y-3 text-xs text-slate-600">
                ...
                <li className="flex items-start gap-2">
                  ...
                  <a
                    ...
                    className="hover:text-[#1F5EFF] underline decoration-slate-300 hover:decoration-[#1F5EFF] transition-colors"
                  >
                    <strong>RBI Master Circular:</strong> Fair Practices Code for Small Finance Banks &amp; Outsourcing of Financial Services
                  </a>
                </li>
                <li className="flex items-start gap-2">
                  <ExternalLink className="w-4 h-4 text-[#1F5EFF] flex-shrink-0 mt-0.5" />
                  <a
                    ...
                    className="hover:text-[#1F5EFF] underline decoration-slate-300 hover:decoration-[#1F5EFF] transition-colors"
                  >
                    <strong>AU Small Finance Bank Limited:</strong> Customer Grievance Redressal Policy, Fair Lending Code &amp; Principal Nodal Officer Directory
                  </a>
                </li>
                <li className="flex items-start gap-2">
                  <ExternalLink className="w-4 h-4 text-[#1F5EFF] flex-shrink-0 mt-0.5" />
          ...
          <aside className="w-full sticky top-24 space-y-6">
            ...
            <div className="bg-gradient-to-br from-[#1F5EFF] to-blue-700 text-white rounded-2xl p-6 shadow-lg">
              <div className="flex items-center gap-2 text-blue-100 text-xs font-bold uppercase tracking-wider mb-2">
                ...
                <span>AU Bank Dispute Resolution</span>
              </div>
