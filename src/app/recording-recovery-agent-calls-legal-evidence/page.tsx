...
export const metadata: Metadata = {
  ...
  description: 'Learn how to legally record recovery agent calls and threats for court evidence in India under Section 65B of the Indian Evidence Act.',
  keywords: [
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <aside className="w-full lg:col-span-3 lg:sticky lg:top-24 space-y-6 h-fit">
            ...
            <div className="bg-gradient-to-br from-slate-900 to-slate-800 text-white rounded-2xl p-5 shadow-md border border-slate-700">
              ...
              <div className="font-bold text-base text-white mb-2">Facing Harassment or Abusive Calls?</div>
