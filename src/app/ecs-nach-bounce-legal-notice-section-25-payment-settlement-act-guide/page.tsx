...
export const metadata: Metadata = {
  ...
  description: 'Understand the legal implications of an ECS or NACH bounce under Section 25 of the Payment and Settlement Systems Act, and how to defend against criminal.',
  alternates: {
        ...
        <div className="w-full bg-white border-b border-[#DEDEDE] overflow-x-auto whitespace-nowrap scrollbar-hide">
          <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-12 py-3">
            <div className="text-xs md:text-sm text-[#747474] flex items-center gap-2">
              ...
              <Link href="/personal-loan-legal-notice" className="hover:text-[#1F5EFF] transition-colors">Legal Notices</Link>
              <span className="text-gray-300">/</span>
          ...
          <aside className="hidden lg:block w-1/5 min-w-[240px]">
            <div className="sticky top-24 space-y-6">
              ...
              <div className="bg-[#2E2E2E] rounded-3xl p-8 text-center text-white border border-white/10 shadow-2xl relative overflow-hidden group">
                ...
                <div className="text-xl font-black mb-4 relative z-10">Facing Criminal Charges?</div>
