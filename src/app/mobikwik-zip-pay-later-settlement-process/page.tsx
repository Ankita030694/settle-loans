...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'how to settle mobikwik zip loan',
    'mobikwik zip late fees waiver',
    'mobikwik zip cibil default removal',
    'mobikwik zip recovery agent harassment complaint',
    'mobikwik zip lendbox transactree settlement',
    'mobikwik zip pay later legal notice reply',
    'mobikwik zip ots sanction letter',
    'mobikwik zip no dues certificate',
    'close mobikwik zip account permanently',
...
export default function MobiKwikZipPayLaterSettlementPage() {
  const tocItems = [
    { id: 'bnpl-micro-wallet-trap', title: '1. The BNPL Architecture & Micro-Wallet Trap' },
    { id: 'delinquency-timeline-nbfc-npa', title: '2. Delinquency Lifecycle & NBFC NPA Accounting' },
    { id: 'halting-predatory-fees-mandates', title: '3. Stopping Predatory Late Fees & Mandates' },
    { id: 'ots-haircut-valuation-npv', title: '4. OTS Haircut Framework & NPV Recovery Math' },
    { id: 'infographic-blueprint', title: '5. Visual Resolution Blueprint' },
    { id: 'recovery-harassment-dpdp-defense', title: '6. Harassment Defense & DPDP Protections' },
    { id: 'step-by-step-settlement-roadmap', title: '7. Step-by-Step MobiKwik ZIP Settlement' },
    { id: 'legal-notices-pssa-lok-adalat', title: '8. Legal Notices, Section 25 & Lok Adalat' },
    { id: 'sanction-letter-audit-ndc', title: '9. Sanction Letter Audit & ₹0 NDC Mandate' },
    { id: 'cibil-restoration-rehabilitation', title: '10. CIBIL Resolution & Credit Rehabilitation' },
      ...
      >
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3">
            ...
            >
              <span>Negotiate MobiKwik ZIP Settlement</span>
          ...
          <main className="w-full min-w-0 blog-content">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50/70 border border-blue-200 rounded-2xl p-6 mb-8 shadow-sm">
              <div className="flex items-center gap-2 text-blue-900 font-bold text-base mb-3">
                ...
                <span>Key Takeaways: MobiKwik ZIP Pay Later Settlement</span>
              </div>
            ...
            {/* Section 1: BNPL Architecture & The Micro-Wallet Trap */}
            <section id="bnpl-micro-wallet-trap" className="scroll-mt-24 mb-12">
            ...
            {/* Section 2: Delinquency Lifecycle & NBFC NPA Accounting */}
            <section id="delinquency-timeline-nbfc-npa" className="scroll-mt-24 mb-12">
              <div className="inline-flex items-center gap-2 text-xs font-bold text-[#1F5EFF] uppercase tracking-wider mb-2">
            ...
            {/* Section 4: OTS Haircut Valuation & NPV Recovery Math */}
            <section id="ots-haircut-valuation-npv" className="scroll-mt-24 mb-12">
              ...
              <div className="bg-slate-900 text-white rounded-2xl p-5 my-6 shadow-md border border-slate-800">
                <div className="flex items-center gap-2 text-blue-400 font-bold text-xs uppercase tracking-wider mb-2">
                  <Calculator className="w-4 h-4" />
                  <span>Micro-Credit Recovery Valuation Benchmark</span>
                </div>
            ...
            {/* Section 5: High-Impact Visual Resolution Blueprint (Infographic Banner) */}
            <section id="infographic-blueprint" className="scroll-mt-24 mb-12">
              <div className="bg-white border-2 border-blue-200 rounded-3xl overflow-hidden shadow-lg my-6 text-slate-800">
                <div className="bg-[#0A2540] text-white py-3.5 px-5 flex items-center justify-between border-b-2 border-[#1F5EFF]">
                  ...
                  <a
                    href="/images/infographics/mobikwik-zip-pay-later-settlement-process.jpg"
                    target="_blank"
                ...
                <div className="p-3 md:p-4 bg-slate-50">
                  <div className="rounded-2xl overflow-hidden border border-slate-200 shadow-sm bg-white">
                    <img
                      src="/images/infographics/mobikwik-zip-pay-later-settlement-process.jpg"
                      alt="MobiKwik ZIP Pay Later Debt Settlement Process and OTS Haircut Blueprint"
            ...
            {/* Section 6: Recovery Harassment Defense & DPDP Act */}
            <section id="recovery-harassment-dpdp-defense" className="scroll-mt-24 mb-12">
              <div className="inline-flex items-center gap-2 text-xs font-bold text-[#1F5EFF] uppercase tracking-wider mb-2">
            ...
            {/* Section 7: Step-by-Step MobiKwik ZIP Settlement Roadmap */}
            ...
            {/* Section 8: Legal Notices, Section 25 & Lok Adalat */}
            <section id="legal-notices-pssa-lok-adalat" className="scroll-mt-24 mb-12">
              <div className="inline-flex items-center gap-2 text-xs font-bold text-[#1F5EFF] uppercase tracking-wider mb-2">
            ...
            <section id="cibil-restoration-rehabilitation" className="scroll-mt-24 mb-12">
              <div className="inline-flex items-center gap-2 text-xs font-bold text-[#1F5EFF] uppercase tracking-wider mb-2">
            ...
            <div className="bg-slate-50 border border-slate-200 rounded-2xl p-6 my-10">
              ...
              <div className="flex flex-wrap gap-2.5">
                ...
                <Link
                  ...
                  className="py-2 px-3.5 rounded-full bg-white hover:bg-[#1F5EFF] hover:text-white text-slate-700 text-xs font-semibold transition-all duration-200 border border-slate-200 shadow-sm"
                >
                  PostPe BharatPe Settlement
                </Link>
                <Link
                  href="/onecard-slice-uni-credit-card-settlement"
                  className="py-2 px-3.5 rounded-full bg-white hover:bg-[#1F5EFF] hover:text-white text-slate-700 text-xs font-semibold transition-all duration-200 border border-slate-200 shadow-sm"
                >
                  OneCard &amp; Slice Settlement
                </Link>
                <Link
          ...
          <aside className="w-full sticky top-24 space-y-6">
            ...
            <div className="bg-gradient-to-br from-[#1F5EFF] to-blue-700 text-white rounded-2xl p-6 shadow-lg">
              <div className="flex items-center gap-2 text-blue-100 text-xs font-bold uppercase tracking-wider mb-2">
                ...
                <span>MobiKwik Dispute Resolution</span>
              </div>
