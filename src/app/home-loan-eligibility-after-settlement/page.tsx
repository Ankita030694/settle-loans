...
export const metadata: Metadata = {
  ...
  description: "Can you get a home loan after a loan settlement? Learn how to improve eligibility, rebuild CIBIL, and convert 'settled' status to 'closed'.",
  alternates: {
            ...
            <div className="lg:sticky lg:top-24 space-y-8">
              ...
              <div className="bg-white rounded-2xl border border-[#DEDEDE] shadow-sm p-6">
                ...
                <nav className="flex flex-col gap-3">
                  ...
                  <Link href="/faqs/joint-loan-settlement-co-borrower-implications" className="text-sm text-blue-600 hover:underline">Settling a Joint Loan</Link>
