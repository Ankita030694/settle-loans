...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'cyber crime complaint online against 7 day loan app',
    'chinese loan app harassment complaint',
    'report loan app to cyber cell cybercrime gov in',
    'chakshu portal report fraudulent loan app',
    'rbi digital lending guidelines illegal loan apps',
    'loan app morphed photo blackmail police complaint',
    'national cyber crime helpline 1930 loan fraud',
    'stop loan app harassment contact list sharing',
    'fake loan app fir format bns it act',
...
const tocItems = [
  { id: 'anatomy-of-illegal-loan-app-scams-and-blackmail', title: '1. Anatomy of 7-Day Chinese Loan App Scams & Cyber Extortion Syndicates' },
  { id: 'statutory-framework-bns-it-act-rbi-digital-lending', title: '2. Statutory Legal Framework: BNS, IT Act & RBI Digital Lending Guidelines' },
  { id: 'contact-list-scraping-and-morphed-photo-blackmail', title: '3. Deconstructing the Blackmail Playbook: Contact Scraping & Extortion Mechanics' },
  { id: 'extortion-trap-economics-and-infinite-recovery-loop', title: '4. The Extortion Trap Economics & Zero-Liability Legal Nullity' },
  { id: 'cyber-crime-complaint-visual-roadmap', title: '5. Emergency Cyber Crime Redressal & FIR Visual Roadmap' },
  { id: 'step-by-step-cybercrime-portal-and-1930-reporting', title: '6. Step-by-Step Guide: Filing an Online FIR on cybercrime.gov.in & Helpline 1930' },
  { id: 'chakshu-portal-reporting-and-telecom-blocking', title: '7. Chakshu Portal Reporting: Suspending Fraudulent Numbers, WhatsApp & UPI Handles' },
  { id: 'legal-immunity-and-stopping-third-party-harassment', title: '8. Legal Immunity Protocols: Defending Against Contact Defamation & Harassment' },
  { id: 'legal-vs-illegal-lending-apps-comparative-matrix', title: '9. Legitimate NBFC Digital Lenders vs. Illegal Extortion Loan Apps Matrix' },
  { id: 'company-resolution-section', title: '10. SettleLoans Emergency Cyber Defense & Loan Harassment Advocacy' },
  { id: 'faqs', title: '11. Frequently Asked Questions' },
];

export default function CyberCrimeComplaintIllegalLoanAppsPage() {
  return (
    <div
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <div className="text-xs text-slate-300 border-b border-slate-700 max-w-xl mx-auto pb-3 mb-5 flex flex-wrap items-center justify-center gap-4">
            ...
            <span className="flex items-center gap-1.5">
              ...
              <span>BNS 2023, IT Act 2000 &amp; RBI Digital Lending Compliant</span>
            </span>
          </div>
          ...
          <div className="flex flex-wrap items-center justify-center gap-3">
            ...
            >
              <span>Get Emergency Cyber Legal Protection</span>
            ...
            >
              Request Free Blackmail Case Evaluation
            </Link>
          </div>
        </div>
      </section>
          ...
          <main className="blog-content w-full bg-white space-y-10 min-w-0">
            ...
            <div className="bg-blue-50/80 border border-blue-200 rounded-2xl p-5 sm:p-6 shadow-sm">
              <div className="flex items-center gap-2 text-blue-950 font-black text-sm uppercase tracking-wider mb-3">
                ...
                <span>Key Takeaways: Emergency Cyber Defense &amp; Blackmail Protection</span>
              </div>
            ...
            <section id="extortion-trap-economics-and-infinite-recovery-loop" className="space-y-4">
                ...
                <table className="min-w-full text-xs sm:text-sm">
                  <thead>
                    <tr>
                      ...
                      <th>Path of Compliance (Paying Extortion)</th>
                      <th>Path of Legal Resistance (FIR &amp; Defense)</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
              ...
              <div className="bg-slate-900 text-white rounded-2xl p-5 my-6 shadow-md border border-slate-800">
                <div className="flex items-center gap-2 text-red-400 font-bold text-xs uppercase tracking-wider mb-2">
                  ...
                  <span>Cyber Extortion Escalation Benchmark</span>
                </div>
                <div className="text-center py-3 my-2 bg-slate-800/80 rounded-xl font-mono text-sm sm:text-base text-red-200 border border-slate-700">
            ...
            <section id="cyber-crime-complaint-visual-roadmap" className="space-y-4">
              ...
              <div className="relative w-full rounded-2xl overflow-hidden shadow-lg border border-slate-200 my-6 bg-slate-950 aspect-[16/9]">
                <Image
                  width={1200}
                  height={675}
                  src="/images/infographics/cyber-crime-complaint-illegal-loan-apps-blackmail.jpg"
                  alt="How to File Cyber Crime Complaint Against Illegal Loan App Blackmail Infographic"
            ...
            <section id="step-by-step-cybercrime-portal-and-1930-reporting" className="space-y-4">
              ...
              <div className="space-y-4 my-4">
                <div className="p-4 rounded-xl bg-white border border-slate-200 shadow-sm space-y-2">
                  <div className="flex items-center gap-2 font-bold text-slate-900 text-xs sm:text-sm">
                    <div className="w-6 h-6 rounded-full bg-[#1F5EFF] text-white flex items-center justify-center text-xs font-bold">1</div>
                ...
                <div className="p-4 rounded-xl bg-white border border-slate-200 shadow-sm space-y-2">
                  <div className="flex items-center gap-2 font-bold text-slate-900 text-xs sm:text-sm">
                    <div className="w-6 h-6 rounded-full bg-[#1F5EFF] text-white flex items-center justify-center text-xs font-bold">2</div>
                ...
                <div className="p-4 rounded-xl bg-white border border-slate-200 shadow-sm space-y-2">
                  <div className="flex items-center gap-2 font-bold text-slate-900 text-xs sm:text-sm">
                    <div className="w-6 h-6 rounded-full bg-[#1F5EFF] text-white flex items-center justify-center text-xs font-bold">3</div>
                ...
                <div className="p-4 rounded-xl bg-white border border-slate-200 shadow-sm space-y-2">
                  <div className="flex items-center gap-2 font-bold text-slate-900 text-xs sm:text-sm">
                    <div className="w-6 h-6 rounded-full bg-[#1F5EFF] text-white flex items-center justify-center text-xs font-bold">4</div>
                ...
                <div className="p-4 rounded-xl bg-white border border-slate-200 shadow-sm space-y-2">
                  <div className="flex items-center gap-2 font-bold text-slate-900 text-xs sm:text-sm">
                    <div className="w-6 h-6 rounded-full bg-[#1F5EFF] text-white flex items-center justify-center text-xs font-bold">5</div>
                ...
                <table className="min-w-full text-xs sm:text-sm">
                  <thead>
                    <tr>
                      ...
                      <th>RBI-Regulated Digital Lenders (Banks / NBFCs)</th>
                      <th>Illegal 7-Day Lending Apps (Cyber Syndicates)</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
            ...
            <section className="border-t border-slate-200 pt-8 mb-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 text-xs">
                ...
                >
                  <span className="font-semibold text-slate-800">National Cyber Crime Reporting Portal (cybercrime.gov.in &amp; Helpline 1930)</span>
                ...
                <a
                  ...
                  className="p-3 bg-white border border-slate-200 rounded-xl hover:border-blue-300 hover:text-[#1F5EFF] transition-all flex items-center justify-between shadow-sm"
                >
                  <span className="font-semibold text-slate-800">DoT Sanchar Saathi – Chakshu Portal (Suspected Fraud Communication Reporting)</span>
                  <ExternalLink className="w-3.5 h-3.5 text-slate-400" />
                </a>
                <a
                  ...
                  className="p-3 bg-white border border-slate-200 rounded-xl hover:border-blue-300 hover:text-[#1F5EFF] transition-all flex items-center justify-between shadow-sm"
                >
                  <span className="font-semibold text-slate-800">RBI Master Direction – Digital Lending Guidelines (Prudential Framework 2022)</span>
                  <ExternalLink className="w-3.5 h-3.5 text-slate-400" />
                </a>
                <span className="font-semibold text-slate-800 underline decoration-slate-300"><span className="font-semibold text-slate-800">Information Technology Act, 2000 &amp; Bharatiya Nyaya Sanhita, 2023</span></span>
                <a
                ...
                >
                  <span className="font-semibold text-slate-800">RBI Integrated Ombudsman Scheme (Fair Practices &amp; Digital Lending Redressal)</span>
                  <ExternalLink className="w-3.5 h-3.5 text-slate-400" />
                </a>
              </div>
            </section>
            ...
            <section className="border-t border-slate-200 pt-8 mb-8">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <Link
                  ...
                  className="py-1.5 px-3 bg-slate-100 hover:bg-blue-50 hover:text-[#1F5EFF] text-slate-700 text-xs font-semibold rounded-lg border border-slate-200 transition-all"
                >
                  Recording Agent Calls Evidence
                </Link>
                <Link
                  href="/recovery-agents-calling-relatives-friends"
                  className="py-1.5 px-3 bg-slate-100 hover:bg-blue-50 hover:text-[#1F5EFF] text-slate-700 text-xs font-semibold rounded-lg border border-slate-200 transition-all"
                >
                  Agents Calling Relatives Protection
                </Link>
                <Link
            ...
            <div className="bg-white border border-slate-200 rounded-2xl p-5 shadow-sm space-y-3">
              ...
              <div className="space-y-2.5 text-xs text-slate-600">
                <div className="flex items-center gap-2">
                  ...
                  <span>BNS 2023 &amp; IT Act 2000 Compliant</span>
                </div>
                <div className="flex items-center gap-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span>Official NCRP Cyber Portal &amp; FIR Support</span>
                </div>
                <div className="flex items-center gap-2">
                  <Scale className="w-4 h-4 text-amber-500 flex-shrink-0" />
                  <span>Advocate-Led Cyber Harassment Defense</span>
                </div>
              </div>
            </div>
