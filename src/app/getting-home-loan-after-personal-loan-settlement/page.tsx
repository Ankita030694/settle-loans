          ...
          <main className="w-full min-w-0 blog-content">
            ...
            <div className="bg-slate-50 border border-slate-200 rounded-2xl p-6 my-10">
              ...
              <ul className="space-y-3 text-xs text-slate-600">
                ...
                <li className="flex items-start gap-2">
                  <ExternalLink className="w-4 h-4 text-[#1F5EFF] flex-shrink-0 mt-0.5" />
                  <span className="font-semibold text-slate-800 underline decoration-slate-300"><strong>Credit Information Companies (Regulation) Act, 2005 (CICRA):</strong> Data Reporting, Account Status Rectification &amp. Dispute Redressal Standards</span>
                </li>
                <li className="flex items-start gap-2">
                  <ExternalLink className="w-4 h-4 text-[#1F5EFF] flex-shrink-0 mt-0.5" />
                  <a
