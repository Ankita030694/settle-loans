...
export const metadata: Metadata = {
  ...
  description: "Struggling with Fibe (EarlySalary) debt? Learn the expert process for Fibe loan settlement and OTS. Settle for 40-70% less, stop collection calls.",
  alternates: {
