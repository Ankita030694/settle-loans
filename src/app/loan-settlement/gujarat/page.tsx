        ...
        <div className="w-full flex flex-col lg:flex-row min-h-screen">
          ...
          <article className="w-full lg:w-[60%] px-4 md:px-12 py-12 prose prose-lg max-w-none text-[#2E2E2E] leading-relaxed">
            ...
            <section id="gujarat-money-lenders-act" className="scroll-mt-32 mb-16">
              <h3 className="text-3xl font-black mb-6">Decoding the Gujarat Money Lenders Act 2011: Your Primary Legal Shield</h3>
            ...
            <section id="gslsa-lok-adalat-process" className="scroll-mt-32 mb-16">
              <h3 className="text-3xl font-black mb-6">The Power of GSLSA Lok Adalats: Your Path to Amicable Settlement</h3>
            ...
            <section id="sarfaesi-property-protection" className="scroll-mt-32 mb-16">
              <h3 className="text-3xl font-black mb-6">Navigating SARFAESI Act and Property Rights in Industrial Gujarat</h3>
            ...
            <section id="consumer-forum-arbitration" className="scroll-mt-32 mb-16">
              <h3 className="text-3xl font-black mb-6">Consumer Forum Advocacy: Fighting Banking Negligence and Harassment</h3>
            ...
            <section id="regional-debt-hubs" className="scroll-mt-32 mb-16">
              <h3 className="text-3xl font-black mb-6">Regional Debt Hubs in Gujarat: Local Insights and Strategies</h3>
            ...
            <section id="agricultural-debt-relief" className="scroll-mt-32 mb-16">
              <h3 className="text-3xl font-black mb-6">Addressing the Agricultural Debt Crisis in Rural Gujarat</h3>
            ...
            <section id="drt-ahmedabad-strategies" className="scroll-mt-32 mb-16">
              <h3 className="text-3xl font-black mb-6">Navigating the Debt Recovery Tribunal (DRT) Ahmedabad: High-Value Defense</h3>
            ...
            <section id="settleloans-strategic-path" className="scroll-mt-32 mb-16">
              <h3 className="text-3xl font-black mb-6">The SettleLoans Roadmap: Our Winning Strategy for Gujarat Residents</h3>
            ...
            <section id="harassment-prevention-laws" className="scroll-mt-32 mb-16">
              <h3 className="text-3xl font-black mb-6">Stopping Unethical Recovery Harassment in Gujarat: Know Your Laws</h3>
            ...
            <section id="credit-score-restoration" className="scroll-mt-32 mb-16">
              <h3 className="text-3xl font-black mb-6">CIBIL Score Restoration for Gujarat Borrowers: Rebuilding Your Financial Future</h3>
            ...
            <section id="gujarat-success-stories" className="scroll-mt-32 mb-16">
              <h3 className="text-3xl font-black mb-8 text-center">Gujarat Success Stories: Real People, Real Freedom</h3>
              ...
              <div className="grid md:grid-cols-2 gap-6 not-prose">
                ...
                <div className="bg-white p-6 rounded-2xl border border-[#DEDEDE] shadow-sm hover:shadow-md transition-all">
                  <div className="flex items-center mb-4">
                    ...
                    <div>
                      <h5 className="font-bold">Nirav S.</h5>
            ...
            <section id="faqs-gujarat-debt" className="scroll-mt-32 mb-16">
              <h3 className="text-3xl font-black mb-8">Frequently Asked Questions: Gujarat Debt Edition</h3>
            ...
            <section className="mt-16 bg-[#1F5EFF] rounded-3xl p-10 text-center text-white shadow-2xl">
              <h3 className="text-3xl md:text-4xl font-black mb-4">Start Your Debt-Free Life in Gujarat Today</h3>
            ...
            <div className="sticky top-24 p-6 space-y-8 overflow-y-auto max-h-[calc(100vh-6rem)]">
              ...
              <div className="bg-[#2E2E2E] rounded-2xl shadow-xl overflow-hidden border border-[#DEDEDE]/10 flex flex-col">
                <div className="bg-[#1F5EFF] p-4 text-center">
                  <div className="text-lg font-black text-white">Gujarat Helpline</div>
                </div>
              ...
              <div className="bg-white p-6 rounded-2xl border border-[#DEDEDE] shadow-sm">
                 <div className="text-sm font-black uppercase tracking-wider text-[#747474] mb-4 border-b border-[#DEDEDE] pb-2">Why Gujarat Trusts Us</div>
