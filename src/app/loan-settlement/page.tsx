      ...
      <section className="w-full bg-[#2E2E2E] py-16 md:py-24 px-4 md:px-8 lg:px-16 relative overflow-hidden">
        <div className="max-w-5xl mx-auto text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
             ...
             <Link href="/services" className="inline-flex items-center justify-center bg-white text-[#2E2E2E] font-bold py-4 px-10 rounded-[10px] hover:scale-105 transition-all duration-300 text-lg border border-[#DEDEDE]">
              Learn More
            </Link>
          </div>
        </div>
      ...
      <div className="w-full mx-auto px-4 md:px-8 lg:px-12 py-16 flex flex-col lg:flex-row gap-12 relative">
        ...
        <article className="w-full lg:w-3/5 flex-1 max-w-none font-sans text-[var(--color-text-body)]">
          ...
          <div className="mt-16 pt-8 border-t border-[var(--color-border)] text-[var(--color-text-muted)] text-sm italic">
             <p>Disclaimer: The information provided specifically regarding legal and financial outcomes is for educational purposes. Every individual's debt situation is unique. Result snippets shown are illustrative of typical outcomes but individual results may vary. SettleLoans is a service provider helping with negotiation and does not offer legal representation in court unless specified otherwise.</p>
          </div>
        </article>
