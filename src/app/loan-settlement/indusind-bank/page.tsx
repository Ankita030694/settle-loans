...
export const metadata: Metadata = {
  ...
  description: "Struggling with IndusInd Bank debt? Learn the expert process for IndusInd Bank loan settlement and credit card OTS. Settle for 40-70% less and stop.",
  alternates: {
