...
export const metadata: Metadata = {
  ...
  description: "Struggling with debt in Kochi, Thiruvananthapuram, or Kozhikode? Expert legal representation for loan settlement in Kerala.",
  alternates: {
        ...
        <div className="w-full flex flex-col lg:flex-row min-h-screen">
          ...
          <article className="w-full lg:w-[60%] px-4 md:px-12 py-12 prose prose-lg max-w-none text-[#2E2E2E] leading-relaxed font-normal">
            ...
            <section id="kerala-economic-landscape" className="scroll-mt-32 mb-16">
              <h2 className="text-4xl font-black mb-8 leading-tight">Financial Landscape of Debt in Kerala</h2>
