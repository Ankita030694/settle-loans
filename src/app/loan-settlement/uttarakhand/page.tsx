        ...
        <div className="w-full flex flex-col lg:flex-row min-h-screen">
          ...
          <article className="w-full lg:w-[60%] px-4 md:px-12 py-12 prose prose-lg max-w-none text-[#2E2E2E] leading-relaxed">
            ...
            <section id="debt-spiral-mountains" className="scroll-mt-32 mb-16">
              <h3 className="text-3xl font-black mb-6">Breaking the Debt Spiral in the Hill State</h3>
            ...
            <section id="legal-protection-ukslsa" className="scroll-mt-32 mb-16">
              <h3 className="text-3xl font-black mb-6">Legal Protection via Uttarakhand State Legal Services Authority</h3>
            ...
            <section id="lok-adalats-dehradun" className="scroll-mt-32 mb-16">
              <h3 className="text-3xl font-black mb-6">Navigating Lok Adalats in Dehradun and Beyond</h3>
            ...
            <section id="drt-dehradun-procedures" className="scroll-mt-32 mb-16">
              <h3 className="text-3xl font-black mb-6">Professional Representation in DRT Dehradun</h3>
            ...
            <section id="cooperative-bank-ots" className="scroll-mt-32 mb-16">
              <h3 className="text-3xl font-black mb-6">One Time Settlement (OTS) Schemes for Cooperative Banks</h3>
            ...
            <section id="harassment-shield-hills" className="scroll-mt-32 mb-16">
              <h3 className="text-3xl font-black mb-6">Anti-Harassment Shield: Protecting Your Dignity in the Hills</h3>
            ...
            <section id="settlement-roadmap-uk" className="scroll-mt-32 mb-16">
              <h3 className="text-3xl font-black mb-6">Your Roadmap to Financial Freedom in Uttarakhand</h3>
            ...
            <section id="success-stories-uk" className="scroll-mt-32 mb-16">
              <h3 className="text-3xl font-black mb-8 text-center">Uttarakhand Success Stories: Real People, Real Freedom</h3>
              ...
              <div className="grid md:grid-cols-2 gap-6 not-prose">
                ...
                <div className="bg-white p-6 rounded-2xl border border-[#DEDEDE] shadow-sm hover:shadow-md transition-all">
                  <div className="flex items-center mb-4">
                    ...
                    <div>
                      <h5 className="font-bold">Meena Rawat</h5>
            ...
            <section id="cibil-recovery-uk" className="scroll-mt-32 mb-16">
              <h3 className="text-3xl font-black mb-6">Rebuilding Your Credit Score in Uttarakhand</h3>
            ...
            <section id="bank-level-negotiation" className="scroll-mt-32 mb-16">
              <h3 className="text-3xl font-black mb-6">Strategic Bank Level Negotiation</h3>
            ...
            <section id="service-transparency" className="scroll-mt-32 mb-16">
              <h3 className="text-3xl font-black mb-6">Transparency and Integrity in Our Services</h3>
            ...
            <section className="mt-16 bg-[#1F5EFF] rounded-3xl p-10 text-center text-white shadow-2xl">
              <h3 className="text-3xl md:text-4xl font-black mb-4">Start Your Debt Free Life in Uttarakhand Today</h3>
