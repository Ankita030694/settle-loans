            ...
            <section id="scam-prevention" className="scroll-mt-32 mb-16">
              ...
              <div className="bg-red-50 p-8 rounded-2xl border border-red-100">
                ...
                <p className="mt-6 text-sm italic">
                  Legitimate services like <Link href="https://amalegalsolutions.com" target="_blank" rel="noopener noreferrer" className="text-[#1F5EFF] hover:underline">amalegalsolutions.com</Link> and CredSettle operate as registered legal entities and provide transparent fee structures with written service agreements.
                </p>
              </div>
            </section>
