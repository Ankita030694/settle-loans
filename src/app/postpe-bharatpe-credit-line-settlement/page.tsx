...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'bharatpe merchant loan default settlement',
    'postpe credit line settlement percentage',
    'bharatpe recovery agent whatsapp threats',
    'unity small finance bank postpe legal notice',
    'bharatpe daily qr deduction stop',
    'postpe nach bounce charges waiver',
    'resilient innovations postpe default legal notice',
    'rbi digital lending guidelines bharatpe recovery',
    'postpe no dues certificate cibil',
    'bharatpe loan lok adalat settlement',
...
export default function PostPeBharatPeCreditLineSettlementPage() {
  const tocItems = [
    { id: 'fintech-lending-architecture', title: '1. FinTech Architecture & Partner NBFCs' },
    { id: 'delinquency-lifecycle-qr-traps', title: '2. Delinquency Lifecycle & Daily QR Traps' },
    { id: 'stopping-nach-bounce-charges', title: '3. Stopping NACH Bounces & QR Sweeps' },
    { id: 'ots-haircut-policies-npv', title: '4. OTS Haircut Policies & Valuation Matrix' },
    { id: 'infographic-resolution-blueprint', title: '5. Visual Resolution Blueprint' },
    { id: 'whatsapp-harassment-defense', title: '6. WhatsApp Harassment & RBI Protections' },
    { id: 'step-by-step-settlement-roadmap', title: '7. Step-by-Step FinTech Settlement Roadmap' },
    { id: 'legal-notices-arbitration-lok-adalat', title: '8. Section 25 Notices, Arbitration & Lok Adalat' },
    { id: 'sanction-letter-audit-ndc', title: '9. Sanction Letter Audit & ₹0 NDC Mandate' },
    { id: 'cibil-score-rehabilitation', title: '10. CIBIL Score Trajectory & Rehabilitation' },
      ...
      >
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3">
            ...
            >
              <span>Negotiate BharatPe Settlement</span>
          ...
          <main className="w-full min-w-0 blog-content">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50/70 border border-blue-200 rounded-2xl p-6 mb-8 shadow-sm">
              <div className="flex items-center gap-2 text-blue-900 font-bold text-base mb-3">
                ...
                <span>Key Takeaways: PostPe &amp; BharatPe Loan Settlement</span>
              </div>
            ...
            {/* Section 1: FinTech Architecture & Partner NBFCs */}
            <section id="fintech-lending-architecture" className="scroll-mt-24 mb-12">
            ...
            {/* Section 2: Delinquency Lifecycle & Daily QR Traps */}
            <section id="delinquency-lifecycle-qr-traps" className="scroll-mt-24 mb-12">
              <div className="inline-flex items-center gap-2 text-xs font-bold text-[#1F5EFF] uppercase tracking-wider mb-2">
            ...
            {/* Section 4: OTS Haircut Policies & Valuation Matrix */}
            <section id="ots-haircut-policies-npv" className="scroll-mt-24 mb-12">
              <div className="inline-flex items-center gap-2 text-xs font-bold text-[#1F5EFF] uppercase tracking-wider mb-2">
            ...
            <section id="infographic-resolution-blueprint" className="scroll-mt-24 mb-12">
              <div className="bg-white border-2 border-blue-200 rounded-3xl overflow-hidden shadow-lg my-6 text-slate-800">
                <div className="bg-[#0A2540] text-white py-3.5 px-5 flex items-center justify-between border-b-2 border-[#1F5EFF]">
                  ...
                  <a
                    href="/images/infographics/postpe-bharatpe-credit-line-settlement.jpg"
                    target="_blank"
                ...
                <div className="p-3 md:p-4 bg-slate-50">
                  <div className="rounded-2xl overflow-hidden border border-slate-200 shadow-sm bg-white">
                    <img
                      src="/images/infographics/postpe-bharatpe-credit-line-settlement.jpg"
                      alt="PostPe and BharatPe Credit Line & Merchant Loan Settlement Blueprint"
            ...
            {/* Section 6: WhatsApp Harassment & RBI Protections */}
            <section id="whatsapp-harassment-defense" className="scroll-mt-24 mb-12">
              <div className="inline-flex items-center gap-2 text-xs font-bold text-[#1F5EFF] uppercase tracking-wider mb-2">
            ...
            <section id="legal-notices-arbitration-lok-adalat" className="scroll-mt-24 mb-12">
              <div className="inline-flex items-center gap-2 text-xs font-bold text-[#1F5EFF] uppercase tracking-wider mb-2">
          ...
          <aside className="w-full sticky top-24 space-y-6">
            ...
            <div className="bg-gradient-to-br from-[#1F5EFF] to-blue-700 text-white rounded-2xl p-6 shadow-lg">
              <div className="flex items-center gap-2 text-blue-100 text-xs font-bold uppercase tracking-wider mb-2">
                ...
                <span>BharatPe Dispute Resolution</span>
              </div>
