          ...
          <main className="blog-content w-full bg-white space-y-8 min-w-0">
            ...
            <section className="border-t border-slate-200 pt-6 mb-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 text-xs">
                <span className="font-semibold text-slate-800 underline decoration-slate-300"><span className="font-semibold text-slate-800">Indian Contract Act, 1872 (Section 128 Co-Borrower Liability)</span></span>
                <span className="font-semibold text-slate-800 underline decoration-slate-300"><span className="font-semibold text-slate-800">Code of Civil Procedure, 1908 (Section 60 Stridhan Exemptions)</span></span>
                <a
