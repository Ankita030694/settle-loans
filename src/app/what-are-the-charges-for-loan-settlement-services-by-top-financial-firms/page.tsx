                ...
                {[
                  {
                    ...
                    story: <>I was worried about the fees, but <Link href="https://amalegalsolutions.com" target="_blank" rel="noopener noreferrer" className="text-[#1F5EFF] hover:underline">AMA Legal Solutions'</Link> retainer was very fair. They saved me over ₹8 Lakhs and more importantly, they stopped the daily harassment from agents.</>
                  },
                  {
                    name: "Deepa R.",
                    loc: "Bangalore",
            ...
            <div className="sticky top-24 space-y-8">
              ...
              <div className="bg-[#2E2E2E] rounded-2xl shadow-xl overflow-hidden border border-[#DEDEDE]/10 group">
                <div className="bg-[#1F5EFF] p-4 text-center">
                  <div className="text-lg font-black text-white italic underline">Transparent & Affordable</div>
                </div>
              ...
              <div className="bg-white p-6 rounded-2xl border border-[#DEDEDE] shadow-sm">
                <div className="text-sm font-black uppercase tracking-wider text-[#747474] mb-4 border-b border-[#DEDEDE] pb-2 font-bold italic underline">Must Read Guides</div>
