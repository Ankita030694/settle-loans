...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'debt settlement advocates in trivandrum',
    'loan settlement lawyers trivandrum',
    'technopark loan default legal advice',
    'vanchiyoor court cheque bounce advocate',
    'section 138 ni act lawyer trivandrum',
    'section 25 pssa notice defense thiruvananthapuram',
    'kerala bank loan settlement ots',
    'sbi personal loan settlement trivandrum',
    'federal bank loan settlement ots kerala',
    'salary account lien removal advocate trivandrum',
    'dlsa lok adalat trivandrum loan settlement',
    'rbi recovery agent harassment complaint kerala',
...
const jsonLdGraph = {
  ...
  "@graph": [
    ...
    },
    {
      ...
      "address": {
        "@type": "PostalAddress",
        "streetAddress": "MG Road, Statue, Vanchiyoor",
...
const tocItems = [
  { id: "trivandrum-technopark-debt-landscape", title: "1. Technopark & Govt Hub Realities" },
  { id: "delinquency-aging-kerala-hc-safeguards", title: "2. Delinquency Timeline & Kerala HC Norms" },
  { id: "vanchiyoor-court-notice-defense", title: "3. Vanchiyoor Court & Section 138/25 Defense" },
  ...
  { id: "rbi-anti-harassment-kerala-police-limits", title: "7. RBI Anti-Harassment & Police Limits" },
  { id: "trivandrum-advocate-settlement-protocol", title: "8. 5-Step Zonal SARB Settlement Protocol" },
        ...
        >
          ...
          <div className="max-w-4xl mx-auto text-center relative z-10">
            ...
            <div className="flex flex-wrap items-center justify-center gap-3">
              ...
              >
                <span>Consult Trivandrum Debt Advocate</span>
            ...
            <main className="w-full min-w-0 blog-content">
              ...
              <div className="bg-gradient-to-br from-blue-50 to-indigo-50/70 border border-blue-200 rounded-2xl p-6 mb-8 shadow-sm">
                <div className="flex items-center gap-2 text-blue-900 font-bold text-base mb-3">
                  ...
                  <span>Key Takeaways: Personal Loan Settlement in Trivandrum &amp; Kerala</span>
                </div>
              ...
              {/* Section 2: Delinquency Timeline & Kerala High Court Norms */}
              <section id="delinquency-aging-kerala-hc-safeguards" className="scroll-mt-24 mb-12">
                <div className="inline-flex items-center gap-2 text-xs font-bold text-[#1F5EFF] uppercase tracking-wider mb-2">
              ...
              {/* Section 4: Banker's Lien (Section 171) & Salary Protection */}
              ...
              {/* Section 7: Enforcing RBI Anti-Harassment Directives & Kerala Police Limits */}
              <section id="rbi-anti-harassment-kerala-police-limits" className="scroll-mt-24 mb-12">
                <div className="inline-flex items-center gap-2 text-xs font-bold text-[#1F5EFF] uppercase tracking-wider mb-2">
              ...
              {/* Section 8: 5-Step SARB Settlement Protocol in Trivandrum */}
              <section id="trivandrum-advocate-settlement-protocol" className="scroll-mt-24 mb-12">
                <div className="inline-flex items-center gap-2 text-xs font-bold text-[#1F5EFF] uppercase tracking-wider mb-2">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="bg-slate-50 border border-slate-200 rounded-2xl p-6">
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      <div className="font-bold text-slate-900 text-base">District & Sessions Court Thiruvananthapuram</div>
                    </div>
                    <p className="text-sm text-slate-600 leading-relaxed mb-3">
                      <strong>Address:</strong> Vanchiyoor, Thiruvananthapuram, Kerala - 695035
                    </p>
                    <p className="text-xs text-slate-500 leading-relaxed">
                      <strong>Jurisdiction:</strong> Vanchiyoor Judicial First Class Magistrate courts adjudicate ECS bounce and civil money suits under the Kerala judicial framework.
                    </p>
                  </div>
                  <div className="bg-slate-50 border border-slate-200 rounded-2xl p-6">
                    <div className="flex items-center gap-3 mb-3">
                      <Scale className="w-5 h-5 text-[#1F5EFF]" />
                      <div className="font-bold text-slate-900 text-base">District Legal Services Authority (DLSA) Trivandrum</div>
                    </div>
                    <p className="text-sm text-slate-600 leading-relaxed mb-3">
                      <strong>Address:</strong> ADR Centre, District Court Complex, Vanchiyoor, Thiruvananthapuram - 695035
                    </p>
                    <p className="text-xs text-slate-500 leading-relaxed">
                      <strong>Lok Adalat Conciliation:</strong> Operates under Kerala State Legal Services Authority (KELSA) guidelines, facilitating equitable settlements for NRI and domestic borrowers.
                    </p>
                  </div>
                </div>
              </section>
            ...
            <aside className="w-full sticky top-24 space-y-6">
              ...
              <div className="bg-gradient-to-br from-slate-900 to-slate-800 text-white rounded-2xl p-5 shadow-md border border-slate-700">
                <div className="flex items-center gap-2 text-blue-400 font-bold text-xs uppercase tracking-wider mb-2">
                  ...
                  <span>Trivandrum Legal Defense</span>
                </div>
