...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'hdfc credila ots policy',
    'hdfc credila student loan default',
    'hdfc credila grace period compound interest',
    'hdfc credila moratorium interest capitalization waiver',
    'hdfc credila co-borrower liability protection',
    'hdfc credila recovery agent harassment complaint',
    'hdfc credila section 138 legal notice',
    'hdfc credila section 25 pssa notice',
    'hdfc credila collateral property release ndc',
...
export default function HdfcCredilaEducationLoanSettlementPage() {
  const tocItems = [
    { id: 'understanding-credila-nbfc-architecture', title: '1. Specialized NBFC Architecture' },
    { id: 'moratorium-compound-interest-trap', title: '2. Moratorium & Compound Interest Trap' },
    { id: 'credila-delinquency-npa-timeline', title: '3. Delinquency Timeline & Provisioning' },
    { id: 'ots-haircut-valuation-npv-formula', title: '4. OTS Haircuts & Valuation Benchmark' },
    { id: 'infographic-resolution-blueprint', title: '5. Visual Resolution Blueprint' },
    { id: 'co-borrower-liability-recovery-defense', title: '6. Co-Borrower Safeguards & Harassment' },
    { id: 'step-by-step-credila-settlement-process', title: '7. Step-by-Step NBFC Settlement Guide' },
    { id: 'legal-notices-sec138-sec25-sarfaesi-lok-adalat', title: '8. Legal Notices, SARFAESI & Lok Adalat' },
    { id: 'sanction-letter-audit-collateral-ndc', title: '9. Sanction Letter Audit & Deed Return' },
    { id: 'cibil-impact-dual-borrower-rehabilitation', title: '10. CIBIL Trajectory & Score Recovery' },
      ...
      >
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3">
            ...
            >
              <span>Negotiate HDFC Credila Settlement</span>
          ...
          <main className="w-full min-w-0 blog-content">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50/70 border border-blue-200 rounded-2xl p-6 mb-8 shadow-sm">
              <div className="flex items-center gap-2 text-blue-900 font-bold text-base mb-3">
                ...
                <span>Key Takeaways: HDFC Credila Education Loan Settlement</span>
              </div>
            ...
            {/* Section 1: Specialized Education NBFC Architecture */}
            <section id="understanding-credila-nbfc-architecture" className="scroll-mt-24 mb-12">
            ...
            {/* Section 2: Moratorium Mechanics & Grace Period Compound Interest */}
            <section id="moratorium-compound-interest-trap" className="scroll-mt-24 mb-12">
              <div className="inline-flex items-center gap-2 text-xs font-bold text-[#1F5EFF] uppercase tracking-wider mb-2">
                ...
                <table className="min-w-full bg-white">
                  <thead>
                    <tr>
                      ...
                      <th>HDFC Credila Institutional Actions</th>
            ...
            {/* Section 4: OTS Haircut Policies & NPV Valuation Matrix */}
            <section id="ots-haircut-valuation-npv-formula" className="scroll-mt-24 mb-12">
              <div className="inline-flex items-center gap-2 text-xs font-bold text-[#1F5EFF] uppercase tracking-wider mb-2">
              ...
              <div className="bg-slate-900 text-white rounded-2xl p-5 my-6 shadow-md border border-slate-800">
                <div className="flex items-center gap-2 text-blue-400 font-bold text-xs uppercase tracking-wider mb-2">
                  <Calculator className="w-4 h-4" />
                  <span>Education Loan Recovery Valuation Benchmark</span>
                </div>
            ...
            <section id="infographic-resolution-blueprint" className="scroll-mt-24 mb-12">
              <div className="bg-white border-2 border-blue-200 rounded-3xl overflow-hidden shadow-lg my-6 text-slate-800">
                <div className="bg-[#0A2540] text-white py-3.5 px-5 flex items-center justify-between border-b-2 border-[#1F5EFF]">
                  ...
                  <a
                    href="/images/infographics/hdfc-credila-education-loan-settlement.jpg"
                    target="_blank"
                ...
                <div className="p-3 md:p-4 bg-slate-50">
                  <div className="rounded-2xl overflow-hidden border border-slate-200 shadow-sm bg-white">
                    <img
                      src="/images/infographics/hdfc-credila-education-loan-settlement.jpg"
                      alt="HDFC Credila Education Loan Settlement Process and OTS Haircut Guide"
            ...
            {/* Section 6: Co-Borrower Safeguards & Anti-Harassment Protections */}
            <section id="co-borrower-liability-recovery-defense" className="scroll-mt-24 mb-12">
              <div className="inline-flex items-center gap-2 text-xs font-bold text-[#1F5EFF] uppercase tracking-wider mb-2">
            ...
            <section id="step-by-step-credila-settlement-process" className="scroll-mt-24 mb-12">
              <div className="inline-flex items-center gap-2 text-xs font-bold text-[#1F5EFF] uppercase tracking-wider mb-2">
            ...
            {/* Section 8: Legal Notices, SARFAESI & Lok Adalat */}
            <section id="legal-notices-sec138-sec25-sarfaesi-lok-adalat" className="scroll-mt-24 mb-12">
              <div className="inline-flex items-center gap-2 text-xs font-bold text-[#1F5EFF] uppercase tracking-wider mb-2">
            ...
            {/* Section 9: Sanction Letter Audit & Collateral Retrieval */}
            <section id="sanction-letter-audit-collateral-ndc" className="scroll-mt-24 mb-12">
              <div className="inline-flex items-center gap-2 text-xs font-bold text-[#1F5EFF] uppercase tracking-wider mb-2">
            ...
            {/* Section 10: CIBIL Score Trajectory & Dual Credit Rehabilitation */}
            <section id="cibil-impact-dual-borrower-rehabilitation" className="scroll-mt-24 mb-12">
              <div className="inline-flex items-center gap-2 text-xs font-bold text-[#1F5EFF] uppercase tracking-wider mb-2">
            ...
            <div className="bg-slate-50 border border-slate-200 rounded-2xl p-6 my-10">
              ...
              <ul className="space-y-3 text-xs text-slate-600">
                ...
                <li className="flex items-start gap-2">
                  <ExternalLink className="w-4 h-4 text-[#1F5EFF] flex-shrink-0 mt-0.5" />
                  <a
                    href="https://www.hdfccredila.com"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="hover:text-[#1F5EFF] underline decoration-slate-300 hover:decoration-[#1F5EFF] transition-colors"
                  >
          ...
          <aside className="w-full sticky top-24 space-y-6">
            ...
            <div className="bg-gradient-to-br from-[#1F5EFF] to-blue-700 text-white rounded-2xl p-6 shadow-lg">
              <div className="flex items-center gap-2 text-blue-100 text-xs font-bold uppercase tracking-wider mb-2">
                ...
                <span>HDFC Credila Dispute Resolution</span>
              </div>
