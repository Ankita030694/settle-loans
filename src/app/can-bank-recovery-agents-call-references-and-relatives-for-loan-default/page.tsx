...
export const metadata: Metadata = {
  ...
  description: "Addresses the massive social embarrassment caused when banks call the references provided during the loan application. Explains the strict RBI Fair.",
  alternates: {
