...
export default function PersonalLoanSettlementPercentageClient() {
  ...
  return (
    ...
    >
      ...
      {/* B. Animated Stats Strip - Crisp Light Theme */}
        ...
        <div className="max-w-[1720px] mx-auto grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 text-center">
          <div className="p-2">
            <div className="text-xl md:text-3xl font-black text-[#1F5EFF] mb-0.5">
              <AnimatedCounter end={30} suffix="% – 50%" />
            </div>
            <p className="text-xs text-slate-600 font-medium">
              Average Personal Loan Settlement Range
            </p>
          </div>
          <div className="p-2 border-l border-slate-200">
            <div className="text-xl md:text-3xl font-black text-emerald-600 mb-0.5">
              <AnimatedCounter end={50} suffix="% – 70%" />
            </div>
            <p className="text-xs text-slate-600 font-medium">
              Average Debt Haircut / Total Waiver
            </p>
          </div>
          <div className="p-2 border-l border-slate-200">
            <div className="text-xl md:text-3xl font-black text-amber-600 mb-0.5">
              <AnimatedCounter end={250} prefix="₹ " suffix="Cr+" />
            </div>
            <p className="text-xs text-slate-600 font-medium">
              Unsecured Debt Negotiated &amp; Resolved
            </p>
          </div>
          <div className="p-2 border-l border-slate-200">
            <div className="text-xl md:text-3xl font-black text-[#1F5EFF] mb-0.5">
            ...
            <p className="text-xs text-slate-600 font-medium">
              Verified Client Rating (1,850+ Reviews)
            </p>
          </div>
        </div>
      </section>
