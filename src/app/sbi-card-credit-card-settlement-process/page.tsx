...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'sbi credit card debt settlement gurugram legal desk',
    'sbi card lok adalat waiver 60 70 percent',
    'sbi card legal notice section 25 pssa reply',
    'how to settle sbi credit card online',
    'sbi cards and payment services npa rules',
    'sbi credit card no dues certificate timeline rbi',
    'sbi credit card compromise settlement haircut',
    'sbi card dlf cyber city collections reply',
    'sbi simplyclick simplysave card default settlement',
...
export default function SBICardCreditCardSettlementPage() {
  const tocItems = [
    { id: 'sbi-card-corporate-structure-pure-play', title: '1. Corporate Entity & Pure-Play Architecture' },
    { id: 'sbi-card-revolving-apr-debt-spiral', title: '2. Revolving APR, Late Fees & Debt Spiral' },
    { id: 'sbi-card-delinquency-timeline-npa', title: '3. Delinquency Timeline: DPD 1 to NPA' },
    { id: 'sbi-card-ots-haircut-valuation-npv', title: '4. NPV Valuation & Settlement Haircut Matrix' },
    ...
    { id: 'lok-adalat-sbi-card-settlement', title: '7. Lok Adalat Conciliation & 60-70% Waivers' },
    { id: 'step-by-step-sbi-card-settlement', title: '8. Step-by-Step Online Settlement Roadmap' },
      ...
      >
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3">
            ...
            >
              <span>Negotiate SBI Card Settlement</span>
          ...
          <main className="w-full min-w-0 blog-content">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50/70 border border-blue-200 rounded-2xl p-6 mb-8 shadow-sm">
              <div className="flex items-center gap-2 text-blue-900 font-bold text-base mb-3">
                ...
                <span>Key Takeaways: SBI Card Credit Card Settlement</span>
              </div>
            ...
            {/* Section 1: Corporate Entity Reality */}
            <section id="sbi-card-corporate-structure-pure-play" className="scroll-mt-24 mb-12">
            ...
            {/* Section 2: Revolving APR, Late Fees & Compounding Debt Spiral */}
            <section id="sbi-card-revolving-apr-debt-spiral" className="scroll-mt-24 mb-12">
              <div className="inline-flex items-center gap-2 text-xs font-bold text-[#1F5EFF] uppercase tracking-wider mb-2">
            ...
            {/* Section 4: NPV Recovery Valuation & Haircut Slabs */}
            <section id="sbi-card-ots-haircut-valuation-npv" className="scroll-mt-24 mb-12">
              <div className="inline-flex items-center gap-2 text-xs font-bold text-[#1F5EFF] uppercase tracking-wider mb-2">
              ...
              <div className="bg-slate-900 text-white rounded-2xl p-5 my-6 shadow-md border border-slate-800">
                <div className="flex items-center gap-2 text-blue-400 font-bold text-xs uppercase tracking-wider mb-2">
                  <Calculator className="w-4 h-4" />
                  <span>SBI Card Recovery Valuation Benchmark</span>
                </div>
            ...
            <section id="infographic-resolution-blueprint" className="scroll-mt-24 mb-12">
              <div className="bg-white border-2 border-blue-200 rounded-3xl overflow-hidden shadow-lg my-6 text-slate-800">
                <div className="bg-[#0A2540] text-white py-3.5 px-5 flex items-center justify-between border-b-2 border-[#1F5EFF]">
                  ...
                  <a
                    href="/images/infographics/sbi-card-credit-card-settlement-process.jpg"
                    target="_blank"
                ...
                <div className="p-3 md:p-4 bg-slate-50">
                  <div className="rounded-2xl overflow-hidden border border-slate-200 shadow-sm bg-white">
                    <img
                      src="/images/infographics/sbi-card-credit-card-settlement-process.jpg"
                      alt="SBI Card Credit Card Settlement Process and OTS Framework Infographic India"
            ...
            {/* Section 7: National Lok Adalat Settlements & 60%–70% Waivers */}
            <section id="lok-adalat-sbi-card-settlement" className="scroll-mt-24 mb-12">
              <div className="inline-flex items-center gap-2 text-xs font-bold text-[#1F5EFF] uppercase tracking-wider mb-2">
                <Scale className="w-4 h-4" />
            ...
            {/* Section 8: Step-by-Step Online Settlement Roadmap */}
            <section id="step-by-step-sbi-card-settlement" className="scroll-mt-24 mb-12">
              <div className="inline-flex items-center gap-2 text-xs font-bold text-[#1F5EFF] uppercase tracking-wider mb-2">
            ...
            {/* Section 9: Sanction Letter Forensics & Mandatory 30-Day ₹0 NDC */}
          ...
          <aside className="w-full sticky top-24 space-y-6">
            ...
            <div className="bg-gradient-to-br from-[#1F5EFF] to-blue-700 text-white rounded-2xl p-6 shadow-lg">
              <div className="flex items-center gap-2 text-blue-100 text-xs font-bold uppercase tracking-wider mb-2">
                ...
                <span>SBI Card Dispute Resolution</span>
              </div>
            ...
            <div className="bg-slate-50 border border-slate-200 rounded-2xl p-6 shadow-sm">
              ...
              <ul className="space-y-3.5 text-xs text-slate-600">
                <li className="flex items-start gap-2.5">
                  ...
                  <span>
                    <strong>Direct Gurugram Representation:</strong> We bypass third-party collection agencies to negotiate directly with SBI Card Stressed Assets Committees in DLF Cyber City.
                  </span>
                </li>
                <li className="flex items-start gap-2.5">
                  <Check className="w-4 h-4 text-emerald-600 flex-shrink-0 mt-0.5" />
