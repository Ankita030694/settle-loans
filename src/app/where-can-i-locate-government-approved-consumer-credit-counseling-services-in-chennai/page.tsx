          ...
          <article className="w-full lg:w-2/4 flex-1 max-w-none">
            ...
            <section id="professional-alternatives" className="scroll-mt-32 mb-16">
              ...
              <div className="prose prose-lg max-w-none text-[var(--color-text-body)] font-medium">
                ...
                <h3 className="text-2xl font-black mt-10 mb-6 text-[#2E2E2E] border-b-2 border-gray-100 pb-2">1. AMA Legal Solutions (<Link href="https://amalegalsolutions.com" target="_blank" rel="noopener noreferrer" className="text-[#1F5EFF] hover:underline">amalegalsolutions.com</Link>)</h3>
                <p className="mb-6 leading-relaxed">
