...
export const metadata: Metadata = {
  ...
  description: "A legal analysis of the Banker's Right of Set-Off in India. Learn if banks can legally deduct EMI from a joint account without permission or freeze.",
  alternates: {
