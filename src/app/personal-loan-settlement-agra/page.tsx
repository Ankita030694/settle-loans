...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'loan settlement lawyers in agra',
    'debt settlement company agra',
    'agra district court loan default advocate',
    'civil court compound agra debt settlement lawyer',
    'section 138 bounce advocate agra',
    'sikandra industrial area footwear loan settlement',
    'hing ki mandi shoe merchant debt relief',
    'nunhai industrial area factory loan advocate',
    'firozabad glass factory loan settlement',
    'mathura trader debt dispute resolution',
    'dlsa lok adalat agra loan settlement',
    'rbi recovery harassment lawyer agra',
    'sanjay place bank ots settlement agra',
...
const jsonLdGraph = {
  ...
  "@graph": [
    ...
    },
    {
      ...
      "address": {
        "@type": "PostalAddress",
        "streetAddress": "Sanjay Place, M.G. Road",
...
const tocItems = [
  { id: "agra-msme-tourism-debt-landscape", title: "1. Agra MSME, Footwear & Tourism Crisis" },
  { id: "delinquency-aging-npa-safeguards", title: "2. Delinquency Timeline & Allahabad HC Norms" },
  { id: "agra-district-court-notice-defense", title: "3. Agra District Court & Section 138/25 Defense" },
  ...
  { id: "rbi-anti-harassment-agra-police-limits", title: "7. RBI Anti-Harassment & Police Limits" },
  { id: "agra-advocate-settlement-protocol", title: "8. 5-Step Zonal SARB Settlement Protocol" },
        ...
        >
          ...
          <div className="max-w-4xl mx-auto text-center relative z-10">
            ...
            <div className="flex flex-wrap items-center justify-center gap-3">
              ...
              >
                <span>Consult Agra Debt Advocate</span>
            ...
            <main className="w-full min-w-0 blog-content">
              ...
              <div className="bg-gradient-to-br from-blue-50 to-indigo-50/70 border border-blue-200 rounded-2xl p-6 mb-8 shadow-sm">
                <div className="flex items-center gap-2 text-blue-900 font-bold text-base mb-3">
                  ...
                  <span>Key Takeaways: Debt Settlement in Agra &amp; Western Uttar Pradesh</span>
                </div>
              ...
              {/* Section 1: Agra Regional Tourism, MSME Footwear & Handicraft Debt Landscape */}
              <section id="agra-msme-tourism-debt-landscape" className="scroll-mt-24 mb-12">
              ...
              {/* Section 2: Delinquency Aging, NPA Provisioning & Allahabad High Court Safeguards */}
              <section id="delinquency-aging-npa-safeguards" className="scroll-mt-24 mb-12">
                <div className="inline-flex items-center gap-2 text-xs font-bold text-[#1F5EFF] uppercase tracking-wider mb-2">
              ...
              {/* Section 4: Banker's Right of General Lien & Agra Account Shielding */}
              ...
              <section id="infographic-resolution-blueprint" className="scroll-mt-24 mb-12">
                ...
                <div className="relative rounded-2xl overflow-hidden border border-slate-200 shadow-lg my-8 bg-slate-900">
                  <img
                      width={1200}
                      height={675}
                    src="/images/infographics/personal-loan-settlement-agra.jpg"
                    alt="Personal Loan Settlement Process in Agra and Western Uttar Pradesh Resolution Roadmap"
              ...
              {/* Section 7: Anti-Harassment Protections & Enforcing RBI Guidelines in Agra */}
              <section id="rbi-anti-harassment-agra-police-limits" className="scroll-mt-24 mb-12">
                <div className="inline-flex items-center gap-2 text-xs font-bold text-[#1F5EFF] uppercase tracking-wider mb-2">
              ...
              {/* Section 8: 5-Step SARB Settlement Protocol in Agra */}
              <section id="agra-advocate-settlement-protocol" className="scroll-mt-24 mb-12">
                <div className="inline-flex items-center gap-2 text-xs font-bold text-[#1F5EFF] uppercase tracking-wider mb-2">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="bg-slate-50 border border-slate-200 rounded-2xl p-6">
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      <div className="font-bold text-slate-900 text-base">District & Sessions Court Agra</div>
                    </div>
                    <p className="text-sm text-slate-600 leading-relaxed mb-3">
                      <strong>Address:</strong> Civil Lines, Near St. John's College, MG Road, Agra, UP - 282002
                    </p>
                    <p className="text-xs text-slate-500 leading-relaxed">
                      <strong>Jurisdiction:</strong> Handles commercial summary suits and cheque bounce complaints for leather exporters, tourist vendors, and salaried retail borrowers.
                    </p>
                  </div>
                  <div className="bg-slate-50 border border-slate-200 rounded-2xl p-6">
                    <div className="flex items-center gap-3 mb-3">
                      <Scale className="w-5 h-5 text-[#1F5EFF]" />
                      <div className="font-bold text-slate-900 text-base">District Legal Services Authority (DLSA) Agra</div>
                    </div>
                    <p className="text-sm text-slate-600 leading-relaxed mb-3">
                      <strong>Address:</strong> Nyaya Seva Sadan, Judges Compound, Civil Lines, Agra - 282002
                    </p>
                    <p className="text-xs text-slate-500 leading-relaxed">
                      <strong>Lok Adalat Conciliation:</strong> Provides formal Lok Adalat settlement mechanisms that reduce outstanding interest and charges by up to 70% under civil law conciliation.
                    </p>
                  </div>
                </div>
              </section>
