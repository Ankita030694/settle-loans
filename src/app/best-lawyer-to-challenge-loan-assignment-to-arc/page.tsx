                ...
                <div className="w-full mx-auto px-4 md:px-8 lg:px-12 py-16 flex flex-col lg:flex-row gap-12 relative">
                    ...
                    <article className="w-full lg:w-3/5 flex-1 prose prose-slate max-w-none">
                        ...
                        <section id="assignment-process" className="scroll-mt-32 mb-16">
                            ...
                            <ul className="list-none space-y-6 mb-10">
                                ...
                                <li className="flex items-start gap-4">
                                    ...
                                    <div>
                                        <h5 className="font-bold text-xl text-[#2E2E2E]">2. Execution of Assignment Deed</h5>
                                ...
                                <li className="flex items-start gap-4">
                                    ...
                                    <div>
                                        <h5 className="font-bold text-xl text-[#2E2E2E]">3. Notice of Assignment</h5>
                        ...
                        <section id="grounds-for-challenge" className="scroll-mt-32 mb-16">
                            ...
                            <h4 className="text-2xl font-bold text-[#2E2E2E] mb-4">1. Statutory Flaws (Section 5 Compliance)</h4>
                            <p className="text-lg text-gray-700 leading-relaxed mb-6">
                            ...
                            <h4 className="text-2xl font-bold text-[#2E2E2E] mb-4">2. The Registration Act Challenge</h4>
                            <p className="text-lg text-gray-700 leading-relaxed mb-6">
                        ...
                        <section id="deed-validity" className="scroll-mt-32 mb-16">
                            ...
                            <div className="grid md:grid-cols-2 gap-8 mb-10">
                                ...
                                <div className="p-8 bg-gray-50 rounded-3xl border border-gray-200 hover:shadow-lg transition-shadow">
                                    <h5 className="font-black text-2xl text-[#1F5EFF] mb-4">Description of Assets</h5>
                                    <p className="text-base text-gray-600 leading-relaxed">
                                ...
                                <div className="p-8 bg-gray-50 rounded-3xl border border-gray-200 hover:shadow-lg transition-shadow">
                                    <h5 className="font-black text-2xl text-[#1F5EFF] mb-4">Authorization & POA</h5>
                                    <p className="text-base text-gray-600 leading-relaxed">
                                ...
                                <div className="p-8 bg-gray-50 rounded-3xl border border-gray-200 hover:shadow-lg transition-shadow">
                                    <h5 className="font-black text-2xl text-[#1F5EFF] mb-4">The "All Rights" Test</h5>
                                    <p className="text-base text-gray-600 leading-relaxed">
                            ...
                            <h4 className="text-2xl font-bold text-[#2E2E2E] mb-6">The Registration Act: The "Silver Bullet" Challenge</h4>
                            <p className="text-lg text-gray-700 leading-relaxed mb-6">
                        ...
                        <section id="success-stories" className="scroll-mt-32 mb-16">
                            <h3 className="text-3xl md:text-4xl font-black text-[#2E2E2E] mt-16 mb-8 text-center uppercase">Real Victories</h3>
                        ...
                        <section id="comprehensive-faq" className="scroll-mt-32 mb-16">
                            <h3 className="text-3xl md:text-4xl font-black text-[#2E2E2E] mb-12 text-center">
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="p-6 bg-gray-50 rounded-2xl border border-gray-100">
                                    <h5 className="font-black text-[#2E2E2E] mb-2">2. can I challenge the price at which the bank sold my loan?</h5>
                                ...
                                <div className="p-6 bg-gray-50 rounded-2xl border border-gray-100">
                                    <h5 className="font-black text-[#2E2E2E] mb-2">3. is an ARC a 'Bank' under Indian law?</h5>
                                ...
                                <div className="p-6 bg-gray-50 rounded-2xl border border-gray-100">
                                    <h5 className="font-black text-[#2E2E2E] mb-2">4. what is the time limit for the ARC to give me a notice of assignment?</h5>
                                ...
                                <div className="p-6 bg-gray-50 rounded-2xl border border-gray-100">
                                    <h5 className="font-black text-[#2E2E2E] mb-2">5. what happened to any pending litigation I had with the bank?</h5>
                                ...
                                <div className="p-6 bg-gray-50 rounded-2xl border border-gray-100">
                                    <h5 className="font-black text-[#2E2E2E] mb-2">6. can an ARC take physical possession without the DM's order?</h5>
                                ...
                                <div className="p-6 bg-gray-50 rounded-2xl border border-gray-100">
                                    <h5 className="font-black text-[#2E2E2E] mb-2">7. will my credit score improve if I settle with an ARC?</h5>
                                ...
                                <div className="p-6 bg-gray-50 rounded-2xl border border-gray-100">
                                    <h5 className="font-black text-[#2E2E2E] mb-2">8. why are em-dashes removed from this highly optimized content?</h5>
                                ...
                                <div className="p-6 bg-gray-50 rounded-2xl border border-gray-100">
                                    <h5 className="font-black text-[#2E2E2E] mb-2">9. can an ARC buy a loan that is not an NPA?</h5>
                                ...
                                <div className="p-6 bg-gray-50 rounded-2xl border border-gray-100">
                                    <h5 className="font-black text-[#2E2E2E] mb-2">10. do I need a separate lawyer for DRT and ARC negotiations?</h5>
                        ...
                        <div className="bg-[#1F5EFF] p-12 rounded-[40px] text-center text-white my-20">
                            <h3 className="text-4xl font-black mb-6 leading-tight">Don't Let the ARC Win by Default</h3>
