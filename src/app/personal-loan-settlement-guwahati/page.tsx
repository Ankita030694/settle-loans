                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="bg-slate-50 border border-slate-200 rounded-2xl p-6">
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      <div className="font-bold text-slate-900 text-base">Kamrup Metropolitan District & Sessions Court</div>
                    </div>
                    <p className="text-sm text-slate-600 leading-relaxed mb-3">
                      <strong>Address:</strong> Panbazar, MG Road, Guwahati, Assam - 781001
                    </p>
                    <p className="text-xs text-slate-500 leading-relaxed">
                      <strong>Jurisdiction:</strong> Primary trial court for loan default litigation across Kamrup Metro and Guwahati, with appellate jurisdiction resting with Gauhati High Court.
                    </p>
                  </div>
                  <div className="bg-slate-50 border border-slate-200 rounded-2xl p-6">
                    <div className="flex items-center gap-3 mb-3">
                      <Scale className="w-5 h-5 text-[#1F5EFF]" />
                      <div className="font-bold text-slate-900 text-base">District Legal Services Authority (DLSA) Kamrup (M)</div>
                    </div>
                    <p className="text-sm text-slate-600 leading-relaxed mb-3">
                      <strong>Address:</strong> ADR Centre, Panbazar Court Campus, Guwahati - 781001
                    </p>
                    <p className="text-xs text-slate-500 leading-relaxed">
                      <strong>Lok Adalat Conciliation:</strong> Offers pre-litigation dispute resolution for commercial loans and personal debt under Assam State Legal Services Authority mandates.
                    </p>
                  </div>
                </div>
              </section>
...
<section id="faqs" className="space-y-4 border-t border-slate-200 pt-8">
            ...
            <section className="border-t border-slate-200 pt-8 mb-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 text-xs">
                ...
                <a
                  href="https://indiacode.gov.in/handle/123456789/2256"
                  target="_blank"
                  rel="noopener noreferrer"
