...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'ujjivan sfb micro loan settlement process',
    'ujjivan small finance bank ots policy',
    'ujjivan bank group loan default rules rbi',
    'how to stop ujjivan bank recovery harassment',
    'ujjivan sfb section 25 pssa legal notice reply',
    'ujjivan small finance bank loan settlement percentage',
    'ujjivan bank no dues certificate after settlement',
    'ujjivan small finance bank nodal officer complaint',
    'ujjivan bank lok adalat settlement',
    'ujjivan sfb individual business loan settlement'
  ],
  alternates: {
  ...
  openGraph: {
    ...
    images: [
      {
        url: 'https://www.settleloans.in/images/infographics/ujjivan-small-finance-bank-loan-settlement.jpg',
        width: 1200,
        height: 675,
        alt: 'Ujjivan Small Finance Bank Loan Settlement Process and OTS Haircut Guide',
      },
    ],
    locale: 'en_IN',
    type: 'article',
...
const jsonLdGraph = {
  ...
  "@graph": [
    ...
    },
    {
      ...
      "itemListElement": [
        ...
        },
        {
          "@type": "ListItem",
          "position": 2,
          "name": "Ujjivan Small Finance Bank Loan Settlement",
          "item": "https://www.settleloans.in/ujjivan-small-finance-bank-loan-settlement"
        }
      ]
    },
    {
    ...
    {
      "@type": "FAQPage",
      "@id": "https://www.settleloans.in/ujjivan-small-finance-bank-loan-settlement#faq",
      "mainEntity": [
        {
          "@type": "Question",
...
export default function UjjivanSmallFinanceBankLoanSettlementPage() {
  const tocItems = [
    { id: 'understanding-ujjivan-defaults', title: '1. SFB Credit Model & Default Pressures' },
    { id: 'ujjivan-delinquency-timeline-npa', title: '2. Delinquency Timeline & NPA Stages' },
    { id: 'rbi-anti-coercive-recovery-protections', title: '3. RBI Protections Against Coercive Recovery' },
    { id: 'stopping-ujjivan-bounce-charges-nach', title: '4. Halting NACH Bounce Charges & Penal Fees' },
    { id: 'ujjivan-ots-haircut-policy-npv', title: '5. OTS Haircut Policies & Valuation Framework' },
    { id: 'infographic-resolution-blueprint', title: '6. Visual Resolution Blueprint' },
    { id: 'step-by-step-ujjivan-settlement', title: '7. Step-by-Step SFB Settlement Roadmap' },
      ...
      >
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3">
            ...
            >
              <span>Negotiate Ujjivan SFB Settlement</span>
          ...
          <main className="w-full min-w-0 blog-content">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50/70 border border-blue-200 rounded-2xl p-6 mb-8 shadow-sm">
              <div className="flex items-center gap-2 text-blue-900 font-bold text-base mb-3">
                ...
                <span>Key Takeaways: Ujjivan Small Finance Bank Loan Settlement</span>
              </div>
            ...
            <section id="understanding-ujjivan-defaults" className="scroll-mt-24 mb-12">
            ...
            <section id="ujjivan-delinquency-timeline-npa" className="scroll-mt-24 mb-12">
              <div className="inline-flex items-center gap-2 text-xs font-bold text-[#1F5EFF] uppercase tracking-wider mb-2">
            ...
            {/* Section 4: Halting NACH Bounce Charges & Penal Levies */}
            <section id="stopping-ujjivan-bounce-charges-nach" className="scroll-mt-24 mb-12">
              <div className="inline-flex items-center gap-2 text-xs font-bold text-[#1F5EFF] uppercase tracking-wider mb-2">
            ...
            <section id="ujjivan-ots-haircut-policy-npv" className="scroll-mt-24 mb-12">
              <div className="inline-flex items-center gap-2 text-xs font-bold text-[#1F5EFF] uppercase tracking-wider mb-2">
            ...
            <section id="infographic-resolution-blueprint" className="scroll-mt-24 mb-12">
              <div className="bg-white border-2 border-blue-200 rounded-3xl overflow-hidden shadow-lg my-6 text-slate-800">
                <div className="bg-[#0A2540] text-white py-3.5 px-5 flex items-center justify-between border-b-2 border-[#1F5EFF]">
                  ...
                  <a
                    href="/images/infographics/ujjivan-small-finance-bank-loan-settlement.jpg"
                    target="_blank"
                ...
                <div className="p-3 md:p-4 bg-slate-50">
                  <div className="rounded-2xl overflow-hidden border border-slate-200 shadow-sm bg-white">
                    <img
                      src="/images/infographics/ujjivan-small-finance-bank-loan-settlement.jpg"
                      alt="Ujjivan Small Finance Bank Loan Settlement and OTS Framework Infographic"
            ...
            <section id="step-by-step-ujjivan-settlement" className="scroll-mt-24 mb-12">
              <div className="inline-flex items-center gap-2 text-xs font-bold text-[#1F5EFF] uppercase tracking-wider mb-2">
          ...
          <aside className="w-full sticky top-24 space-y-6">
            ...
            <div className="bg-gradient-to-br from-[#1F5EFF] to-blue-700 text-white rounded-2xl p-6 shadow-lg">
              <div className="flex items-center gap-2 text-blue-100 text-xs font-bold uppercase tracking-wider mb-2">
                ...
                <span>Ujjivan Dispute Resolution</span>
              </div>
