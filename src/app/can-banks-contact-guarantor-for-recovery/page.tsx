        ...
        <div className="w-full mx-auto px-4 md:px-8 lg:px-12 py-16 flex flex-col lg:flex-row gap-12 relative text-[var(--color-text-body)]">
          ...
          <article className="w-full lg:w-3/5 flex-1 max-w-none font-sans text-[var(--color-text-body)]">
            ...
            <section id="co-applicant-vs-guarantor" className="scroll-mt-32 mb-16">
              <h3 className="text-3xl md:text-4xl font-black text-[#2E2E2E] mb-6">Co-Applicant vs. Guarantor: Knowing the Difference</h3>
              <p className="text-lg leading-relaxed mb-6">
              ...
              <div className="grid md:grid-cols-2 gap-6 my-8">
                <div className="bg-white p-6 rounded-xl border border-[#DEDEDE] shadow-sm">
                  <h4 className="font-black text-[#1F5EFF] text-xl mb-3">The Co-Applicant</h4>
                ...
                <div className="bg-white p-6 rounded-xl border border-[#DEDEDE] shadow-sm">
                  <h4 className="font-black text-[#1F5EFF] text-xl mb-3">The Guarantor</h4>
                  <p className="text-gray-700 m-0">
            ...
            <section id="rbi-guidelines" className="scroll-mt-32 mb-16">
              ...
              <div className="bg-red-50 p-6 rounded-xl border border-red-100 mb-8">
                <h5 className="text-lg font-black text-red-700 mb-2">Warning!</h5>
            ...
            <section id="guarantor-rights" className="scroll-mt-32 mb-16">
              <h3 className="text-3xl md:text-4xl font-black text-[#2E2E2E] mb-6">Legal Rights of a Guarantor</h3>
              <p className="text-lg leading-relaxed mb-6">
              ...
              <div className="grid md:grid-cols-2 gap-6 my-8">
                <div className="bg-[#f8faff] p-6 rounded-xl border border-[#DEDEDE]">
                  <h4 className="font-black text-[#1F5EFF] text-lg mb-3">Right of Subrogation</h4>
                ...
                <div className="bg-[#f8faff] p-6 rounded-xl border border-[#DEDEDE]">
                  <h4 className="font-black text-[#1F5EFF] text-lg mb-3">Right to Information</h4>
                ...
                <div className="bg-[#f8faff] p-6 rounded-xl border border-[#DEDEDE]">
                  <h4 className="font-black text-[#1F5EFF] text-lg mb-3">Right Against Unfair Terms</h4>
                ...
                <div className="bg-[#f8faff] p-6 rounded-xl border border-[#DEDEDE]">
                  <h4 className="font-black text-[#1F5EFF] text-lg mb-3">Right to Be Sued Later</h4>
            ...
            <section id="legal-notices" className="scroll-mt-32 mb-16">
              <h3 className="text-3xl md:text-4xl font-black text-[#2E2E2E] mb-6">What to Do If You Receive a Legal Notice</h3>
              <p className="text-lg leading-relaxed mb-6">
              ...
              <div className="space-y-6 my-8">
                <div className="bg-gray-50 p-6 rounded-2xl border border-gray-200">
                  <h4 className="text-xl font-bold text-[#2E2E2E] mb-2">Section 138 (Cheque Bounce) Notices</h4>
                ...
                <div className="bg-gray-50 p-6 rounded-2xl border border-gray-200">
                  <h4 className="text-xl font-bold text-[#2E2E2E] mb-2">Arbitration Notices</h4>
                  <p className="text-gray-700 mb-0">
                ...
                <div className="bg-gray-50 p-6 rounded-2xl border border-gray-200">
                  <h4 className="text-xl font-bold text-[#2E2E2E] mb-2">SARFAESI Act (For Secured Loans)</h4>
                  <p className="text-gray-700 mb-0">
            ...
            <section id="removing-guarantor" className="scroll-mt-32 mb-16">
              <h3 className="text-3xl md:text-4xl font-black text-[#2E2E2E] mb-6">Can a Guarantor Be Removed from a Loan?</h3>
              <p className="text-lg leading-relaxed mb-6">
              ...
              <div className="bg-white rounded-2xl border border-[#DEDEDE] overflow-hidden mb-8 shadow-sm">
                ...
                <div className="p-6 border-b border-[#DEDEDE] flex items-start gap-4">
                  <div className="w-8 h-8 rounded-full bg-green-100 text-green-600 flex items-center justify-center font-bold flex-shrink-0 mt-1">✓</div>
                  <div>
                    <h5 className="text-lg font-bold text-[#2E2E2E] mb-2">Offering Alternate Collateral</h5>
                ...
                <div className="p-6 flex items-start gap-4">
                  <div className="w-8 h-8 rounded-full bg-green-100 text-green-600 flex items-center justify-center font-bold flex-shrink-0 mt-1">✓</div>
                  <div>
                    <h5 className="text-lg font-bold text-[#2E2E2E] mb-2">Partial Prepayment</h5>
            ...
            <section id="impact-on-cibil" className="scroll-mt-32 mb-16">
              <h3 className="text-3xl md:text-4xl font-black text-[#2E2E2E] mb-6">Impact on Guarantor's CIBIL Score</h3>
            ...
            <section id="how-to-stop-harassment" className="scroll-mt-32 mb-16">
              <h3 className="text-3xl md:text-4xl font-black text-[#2E2E2E] mb-6">How to Stop Agent Harassment</h3>
              <p className="text-lg leading-relaxed mb-6">
              ...
              <div className="space-y-12 my-8">
                ...
                <div className="flex gap-6">
                  ...
                  <div>
                    <h5 className="text-xl font-bold text-[#2E2E2E] mb-2">Record the Conversations</h5>
                ...
                <div className="flex gap-6">
                  ...
                  <div>
                    <h5 className="text-xl font-bold text-[#2E2E2E] mb-2">File a Police Complaint</h5>
                ...
                <div className="flex gap-6">
                  ...
                  <div>
                    <h5 className="text-xl font-bold text-[#2E2E2E] mb-2">Escalate to RBI Ombudsman</h5>
              ...
              <div className="grid md:grid-cols-2 gap-6 my-8">
                ...
                <div className="bg-white p-8 rounded-[30px] border border-[#DEDEDE] shadow-sm hover:shadow-xl group transition-all">
                  <div className="flex items-center gap-4 mb-6">
                    ...
                    <div>
                      <h5 className="font-bold text-gray-900 m-0">Meera V.</h5>
                      <div className="flex text-yellow-400">
                        <svg className="w-4 h-4 fill-current" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" /></svg>
                        <svg className="w-4 h-4 fill-current" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" /></svg>
                        <svg className="w-4 h-4 fill-current" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" /></svg>
            ...
            <div className="bg-[#2E2E2E] text-white p-12 rounded-[40px] text-center mt-24 relative overflow-hidden group">
              ...
              <div className="relative z-10">
                <h4 className="text-3xl md:text-5xl font-black mb-6">Stop Guarantor Harassment Today</h4>
