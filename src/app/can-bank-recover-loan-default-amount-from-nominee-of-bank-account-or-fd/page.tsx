...
export const metadata: Metadata = {
  ...
  description: "Learn the legal difference between a nominee and a legal heir. Find out if a bank can attach or freeze a nominee's FD or savings account for a deceased.",
  alternates: {
