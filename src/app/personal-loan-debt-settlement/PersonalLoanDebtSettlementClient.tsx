          ...
          <main className="min-w-0">
            ...
            <div className="flex flex-wrap items-center justify-between gap-4 mb-10 pb-6 border-b border-slate-200">
              ...
              <div className="flex items-center gap-3">
                ...
                <a href="https://twitter.com/intent/tweet?url=https%3A%2F%2Fsettleloans.in%2Fpersonal-loan-debt-settlement&text=Personal+Loan+Debt+Settlement" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-black flex items-center justify-center hover:opacity-80 transition-opacity" aria-label="Share on X">
                  <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                </a>
                <a href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fsettleloans.in%2Fpersonal-loan-debt-settlement" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-[#1877F2] flex items-center justify-center hover:opacity-80 transition-opacity" aria-label="Share on Facebook">
                  <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.469h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.469h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                </a>
                <a href="https://www.linkedin.com/shareArticle?mini=true&url=https%3A%2F%2Fsettleloans.in%2Fpersonal-loan-debt-settlement&title=Personal+Loan+Debt+Settlement" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-[#0A66C2] flex items-center justify-center hover:opacity-80 transition-opacity" aria-label="Share on LinkedIn">
            ...
            <div className="mt-16 p-8 bg-slate-50 rounded-2xl border border-slate-200">
              ...
              <ul className="list-disc pl-5 space-y-2 text-sm text-slate-600">
                ...
                <li><span className="font-semibold text-slate-800 underline decoration-slate-300">The Indian Contract Act, 1872 (Section 63 regarding waiver of claims)</span></li>
