       ...
       <section className="w-full bg-[#2E2E2E] py-16 md:py-24 px-4 md:px-8 lg:px-16 relative overflow-hidden">
        <div className="max-w-5xl mx-auto text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
             ...
             <Link href="#factors" className="inline-flex items-center justify-center bg-white text-[#2E2E2E] font-bold py-4 px-10 rounded-[10px] hover:scale-105 transition-all duration-300 text-lg border border-[#DEDEDE]">
              Understanding CIBIL
            </Link>
          </div>
        </div>
...
[Your Name]
          ...
          <div className="space-y-4 not-prose mb-20">
           ...
           <div className="mt-16 pt-8 border-t border-[var(--color-border)] text-center">
             <p className="text-[var(--color-text-muted)] text-sm italic">Disclaimer: SettleLoans assists with debt management and legal consultancy. We do not provide credit repair services that violate the Credit Information Companies (Regulation) Act. Improvements are based on correcting errors and adopting healthy financial habits.</p>
          </div>
