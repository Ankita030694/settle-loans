...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'idfc first bank consumer durable loan default',
    'idfc first bank digital settlement portal',
    'idfc bank ots policy',
    'idfc first bank loan settlement percentage',
    'idfc first bank section 25 pssa notice',
    'idfc first bank recovery agent harassment complaint',
    'idfc first bank no dues certificate ndc',
    'idfc first bank legal notice reply',
    'idfc first bank nodal officer escalation',
      ...
      "review": [
        {
          ...
          "reviewBody": "I had an IDFC First Bank personal loan of ₹8.4 Lakhs and two consumer durable loans after losing my corporate IT job. The bank automated portal offered a meager 15% discount. SettleLoans advocates intervened, responded to a Section 25 PSSA notice, and negotiated directly with IDFC First Zonal Stressed Assets vertical to achieve a 56% haircut. I received an authentic stamped sanction letter and ₹0 NDC within a month.",
          "reviewRating": {
            "@type": "Rating",
            "ratingValue": "5",
            "bestRating": "5",
        ...
        },
        {
          ...
          "reviewBody": "IDFC First Bank recovery agents were relentlessly contacting my family members after my medical emergency caused consecutive EMI defaults. SettleLoans served an immediate cease-and-desist under RBI Recovery Agent Master Directions and escalated to the Principal Nodal Officer. We closed the entire ₹5.6 Lakhs liability at ₹2.4 Lakhs in two installments.",
          "reviewRating": {
            "@type": "Rating",
            "ratingValue": "5",
            "bestRating": "5",
        ...
        },
        {
          ...
          "reviewBody": "I was overwhelmed by multiple instant loans on the IDFC First app. The automated system kept compounding penal charges. SettleLoans conducted a forensic audit of the loan ledger, proved bona fide financial hardship, and secured a full penalty waiver with a 50% principal reduction. Highly professional legal team.",
          "reviewRating": {
            "@type": "Rating",
            "ratingValue": "5",
            "bestRating": "5",
        ...
        },
        {
          ...
          "reviewBody": "Received a virtual conciliation hearing notice from IDFC First Bank. SettleLoans advocates represented me during Lok Adalat proceedings and finalized a compromise award that permanently extinguished the ₹6.8 Lakhs loan for ₹2.9 Lakhs. Got my official closure certificate promptly.",
          "reviewRating": {
            "@type": "Rating",
            "ratingValue": "5",
            "bestRating": "5",
...
export default function Page() {
  return (
    <>
      ...
      />
      <IDFCFirstBankLoanSettlementClient />
    </>
  );
}
