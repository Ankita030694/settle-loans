...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'debt settlement company lucknow',
    'gomti nagar loan settlement advocate',
    'kaisarbagh court loan default advocate',
    'allahabad high court lucknow bench debt lawyer',
    'cjm court lucknow section 138 bounce lawyer',
    'upslsa lok adalat lucknow personal loan',
    'up government salary account protection section 171',
    'rbi recovery harassment lawyer lucknow',
    'one time settlement ots lucknow banks',
  ...
  "@graph": [
    ...
    },
    {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "Why do salaried and government employees in Lucknow require specialized loan settlement advocates?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Salaried executives, healthcare personnel, and Uttar Pradesh state government employees across Lucknow, Gomti Nagar, and Kanpur face specific vulnerabilities during financial default. Recovery agents often leverage fear of disciplinary inquiries, workplace defamation, and arbitrary salary account freezes. Specialized Lucknow debt settlement advocates invoke central banking guidelines, enforce Code of Civil Procedure salary exemptions, issue formal cease-and-desist notices to bank zonal offices in Hazratganj and Vibhuti Khand, and negotiate structured One-Time Settlements (OTS) with 40% to 70% waivers."
          }
        },
        {
          "@type": "Question",
          "name": "Can a bank freeze my UP Government Treasury salary account under Banker's Lien in Lucknow?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Under Section 171 of the Indian Contract Act, 1872, a bank holds a general lien only over accounts maintained within its own branches. However, lenders cannot attach or debit salary accounts maintained at separate, unlinked banks without an explicit court order. Additionally, under Section 60(1) of the Code of Civil Procedure (CPC), 1908, statutory salary attachment thresholds strictly shield subsistence income. Our legal team assists borrowers in legally rerouting salary credits and revoking NACH mandates to ensure essential living funds remain protected."
          }
        },
        {
          "@type": "Question",
          "name": "Can the Lucknow Police or UP Police arrest me or register an FIR for defaulting on an unsecured personal loan?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "No. Unsecured personal loan or credit card default is strictly a civil breach of contract under the Indian Contract Act, 1872. The Uttar Pradesh Police and local police stations across Hazratganj, Gomti Nagar, Aliganj, or Ashiyana have zero statutory authority to summon, detain, or register FIRs against borrowers for financial default. Under Supreme Court precedents in Arnesh Kumar and Lalita Kumari, police officials are prohibited from converting civil commercial recovery matters into criminal proceedings."
          }
        },
        {
          "@type": "Question",
          "name": "How should I respond to a Section 138 NI Act or Section 25 PSSA notice from Lucknow District Court?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Upon receiving a statutory demand notice for a bounced cheque (Section 138 NI Act) or electronic NACH mandate (Section 25 PSSA), you have a critical 15-day statutory window to reply. Empanelled Lucknow advocates draft an assertive legal reply establishing involuntary financial hardship, disputing inflated penal levies, and proposing conciliation. If a complaint is filed at the Kaisarbagh District Court or CJM Court, our advocates enter appearance under Vakalatnama, obtain immediate bail, and refer the matter to the National Lok Adalat for an agreed OTS compromise."
          }
        },
        {
          "@type": "Question",
          "name": "How does the Uttar Pradesh State Legal Services Authority (UPSLSA) Lok Adalat facilitate loan settlement?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "The Uttar Pradesh State Legal Services Authority (UPSLSA) conducts National and Special Lok Adalats at the District Court Complex in Kaisarbagh and the Allahabad High Court Lucknow Bench premises. Pre-litigation and pending recovery cases placed before the Lok Adalat bench are settled through mutually agreed compromise. Under Section 21 of the Legal Services Authorities Act, 1987, the Lok Adalat award carries the force of a final Civil Court decree with zero appeal, ensuring 100% refund of court fees and total immunity from future litigation."
          }
        },
        {
          "@type": "Question",
          "name": "Can the entire loan settlement procedure in Lucknow and Kanpur be executed remotely?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes. SettleLoans operates a fully digital, legally protected advisory infrastructure. From financial hardship docket preparation, drafting legal replies, coordinating with Zonal Stressed Assets Recovery Branches (SARB) across Ashok Marg, Hazratganj, and Kanpur Mall Road, to auditing official bank sanction letters, every step is conducted securely online. When physical court appearances are required in Kaisarbagh or Kanpur Nagar courts, our empanelled advocates represent you under Vakalatnama."
          }
        },
        {
          "@type": "Question",
          "name": "What percentage of debt waiver is achievable through PSU and Private Bank OTS in Lucknow?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Depending on delinquency aging (90 to 180+ days past due), asset classification (Substandard, Doubtful, or Loss Asset), and documented financial distress (job loss, business contraction, medical emergencies), Lucknow debt settlement advocates routinely secure 40% to 70% waivers on total book outstanding, alongside a complete 100% waiver of accumulated penal interest, compounding levies, and late fees."
          }
        },
        {
          "@type": "Question",
          "name": "How do advocates protect borrowers from aggressive recovery agent visits in Gomti Nagar and Hazratganj?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Advocates issue formal Cease-and-Desist notices citing RBI Master Directions on Recovery Agents and Section 35A of the Banking Regulation Act. The notice bars third-party recovery agencies from visiting government secretariats, corporate IT offices in Vibhuti Khand, or private residences. Any violation triggers immediate statutory complaints to the bank's Principal Nodal Officer, the RBI Banking Ombudsman (CMS Portal), and the Lucknow Police Commissionerate."
          }
        },
        {
          "@type": "Question",
      ...
      "review": [
        {
          ...
          "reviewBody": "As an employee in a UP state public department based in Hazratganj, I faced severe debt stress with ₹16 Lakhs across two personal loans after heavy family healthcare expenses. Collection callers started threatening to visit my office. SettleLoans intervened immediately, served legal notices to the bank's regional head office in Vibhuti Khand, protected my salary account, and closed both accounts at a 60% OTS waiver through the UPSLSA Lok Adalat.",
          "reviewRating": {
            "@type": "Rating",
            "ratingValue": "5",
            "bestRating": "5",
        ...
        },
        {
          ...
          "reviewBody": "My retail distribution business in Aminabad and Kanpur faced severe working capital erosion, resulting in ₹11.5 Lakhs in defaulted unsecured loans. SettleLoans analyzed the NPA classification timeline, shielded me from Section 138 threats in Kaisarbagh District Court, and concluded a clean One-Time Settlement with an authentic bank sanction letter and ₹0 No Dues Certificate.",
          "reviewRating": {
            "@type": "Rating",
            "ratingValue": "5",
            "bestRating": "5",
        ...
        },
        {
          ...
          "reviewBody": "Received Section 25 PSSA legal notices from a private lender while managing clinical practice in Gomti Nagar. The advocates at SettleLoans drafted an unassailable 15-day response establishing genuine hardship, dismantled inflated compounding interest charges, and negotiated a 55% principal waiver directly with the Zonal Stressed Assets Recovery Branch.",
          "reviewRating": {
            "@type": "Rating",
            "ratingValue": "5",
            "bestRating": "5",
        ...
        },
        {
          ...
          "reviewBody": "Outstanding debt defense service in Lucknow. When aggressive agency executives attempted unannounced visits to my home in Indira Nagar, SettleLoans issued cease-and-desist notices invoking RBI Fair Practices Directions. The harassment stopped within 24 hours, and the debt was resolved with a structured 65% haircut.",
          "reviewRating": {
            "@type": "Rating",
            "ratingValue": "5",
            "bestRating": "5",
...
const tocItems = [
  { id: "regional-debt-landscape-lucknow", title: "1. Lucknow & UP Regional Debt Realities" },
  { id: "npa-timeline-allahabad-hc-jurisprudence", title: "2. Delinquency Timeline & Allahabad HC Norms" },
  { id: "statutory-notices-kaisarbagh-defense", title: "3. Kaisarbagh Court & Section 138/25 Defense" },
  { id: "bankers-lien-up-salary-shielding", title: "4. Section 171 Lien & UP Salary Shielding" },
  ...
  { id: "anti-harassment-up-police-boundaries", title: "7. Anti-Harassment & Police Boundaries in UP" },
  { id: "advocate-settlement-roadmap-lucknow", title: "8. 5-Step SARB Settlement Protocol" },
        ...
        >
          ...
          <div className="max-w-4xl mx-auto text-center relative z-10">
            <div className="inline-flex items-center gap-2 py-1 px-3.5 rounded-full bg-blue-500/20 border border-blue-400/30 text-blue-300 text-xs font-black mb-3 tracking-wider uppercase">
              ...
              <span>Regional Debt Resolution • Lucknow &amp; Uttar Pradesh</span>
            </div>

            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-[38px] xl:text-[42px] font-black leading-tight tracking-tight text-white mb-5">
              Personal Loan Settlement Advocates in Lucknow: <span className="text-[#3b82f6] md:text-[#60a5fa]">Legal Notice Defense &amp; OTS Debt Relief</span>
            </h1>
            ...
            <div className="flex flex-wrap items-center justify-center gap-3">
              ...
              >
                <span>Consult Lucknow Debt Advocate</span>
            ...
            <aside className="w-full sticky top-24 space-y-4">
              ...
              <div className="bg-blue-50/60 border border-blue-200/70 rounded-2xl p-4 text-xs text-blue-900 space-y-2">
                <div className="font-bold flex items-center gap-1.5 text-blue-950">
                  ...
                  <span>Lucknow Legal Crux</span>
                </div>
                <p className="text-[11px] leading-relaxed text-blue-800">
                  Unsecured personal loan default in Uttar Pradesh is strictly a civil breach of contract. By asserting RBI Fair Practices protections, replying to Section 138/25 notices in Kaisarbagh courts, and engaging Zonal SARB desks in Hazratganj and Vibhuti Khand, borrowers can permanently stop agency harassment and achieve 40%–70% OTS debt waivers.
                </p>
              </div>
            </aside>
            ...
            <main className="w-full min-w-0 blog-content">
              ...
              <div className="bg-gradient-to-br from-blue-50 to-indigo-50/70 border border-blue-200 rounded-2xl p-6 mb-8 shadow-sm">
                <div className="flex items-center gap-2 text-blue-900 font-bold text-base mb-3">
                  ...
                  <span>Key Takeaways: Personal Loan Settlement in Lucknow &amp; UP</span>
                </div>
                <ul className="space-y-2.5 text-sm text-slate-700">
                  <li className="flex items-start gap-2.5">
                    <CheckCircle2 className="w-4 h-4 text-[#1F5EFF] flex-shrink-0 mt-0.5" />
                    <span><strong>Civil Character of Loan Default in UP:</strong> Under Indian contract law and established Allahabad High Court jurisprudence, loan default is purely a civil contractual dispute. Local police stations have zero jurisdiction to detain, summon, or register criminal FIRs against borrowers for financial distress.</span>
                  </li>
                  <li className="flex items-start gap-2.5">
                    <CheckCircle2 className="w-4 h-4 text-[#1F5EFF] flex-shrink-0 mt-0.5" />
                    <span><strong>State &amp; Corporate Salary Protection:</strong> Under Section 60(1) of the Code of Civil Procedure (CPC) and Section 171 Contract Act doctrines, public sector and corporate salary accounts are shielded from arbitrary banker attachment when routed to separate banking institutions.</span>
                  </li>
                  <li className="flex items-start gap-2.5">
                    <CheckCircle2 className="w-4 h-4 text-[#1F5EFF] flex-shrink-0 mt-0.5" />
                    <span><strong>Kaisarbagh District Court &amp; Section 138 Defense:</strong> Serving a timely legal reply within 15 days of receiving cheque or NACH bounce notices neutralizes criminal exposure in Lucknow Magistrate Courts and compels banks to enter formal compromise conciliation.</span>
                  </li>
                  <li className="flex items-start gap-2.5">
                    <CheckCircle2 className="w-4 h-4 text-[#1F5EFF] flex-shrink-0 mt-0.5" />
                    <span><strong>Zonal SARB Haircut Slabs (40%–70%):</strong> Negotiating directly with bank Zonal Stressed Assets Recovery Branches in Hazratganj, Vibhuti Khand, and Kanpur Mall Road unlocks 40% to 70% principal waivers and 100% penal interest write-offs.</span>
                  </li>
                  <li className="flex items-start gap-2.5">
                    <CheckCircle2 className="w-4 h-4 text-[#1F5EFF] flex-shrink-0 mt-0.5" />
                    <span><strong>Mandatory ₹0 NDC within 30 Days:</strong> Under RBI Circular RBI/2023-24/60, lenders must issue the official zero-balance No Dues Certificate within 30 days of settlement remittance or pay mandatory compensation of ₹5,000 per day of delay.</span>
                  </li>
                </ul>
              </div>

              {/* Section 1: Regional Debt Realities in Lucknow & Uttar Pradesh */}
              <section id="regional-debt-landscape-lucknow" className="scroll-mt-24 mb-12">
                <div className="inline-flex items-center gap-2 text-xs font-bold text-[#1F5EFF] uppercase tracking-wider mb-2">
                  <Building2 className="w-4 h-4" />
                  <span>1. Lucknow &amp; UP Regional Debt Realities</span>
                </div>
                <h2 className="text-xl sm:text-2xl md:text-3xl font-black text-slate-900 mb-4 leading-tight">The Unsecured Debt Challenge for Salaried Government</h2>
                <p className="text-slate-700 leading-relaxed mb-4 text-base md:text-lg">
                  As the administrative, judicial, and financial capital of Uttar Pradesh, Lucknow represents a unique socio-economic landscape. The city houses the state civil administration centered around the UP Government Secretariat (Bapu Bhawan and Sachivalaya), the Vidhan Sabha, state public sector undertakings such as UP Power Corporation Limited (UPPCL) and UP State Road Transport Corporation (UPSRTC), premier healthcare establishments (KGMU, Sanjay Gandhi PGIMS, and Ram Manohar Lohia Institute), central government organizations like RDSO and HAL, alongside a rapidly expanding IT and financial corporate corridor across Gomti Nagar, Vibhuti Khand, and Amar Shaheed Path. In close proximity, the neighboring industrial hub of Kanpur supports thousands of commercial enterprises, MSME supply vendors, and trading establishments.
                </p>
                <p className="text-slate-700 leading-relaxed mb-4 text-base md:text-lg">
                  Over the preceding five years, aggressive retail credit expansion by major Public Sector Undertaking (PSU) banks (including State Bank of India, Punjab National Bank, Bank of Baroda, Canara Bank, and Union Bank of India) and private commercial lenders (such as HDFC Bank, ICICI Bank, Axis Bank, and Kotak Mahindra Bank), supplemented by non-banking financial companies (NBFCs) like Bajaj Finance and Tata Capital, led to widespread disbursement of unsecured personal loans, consumer durables credit, and instant revolving credit lines.
                </p>
                <p className="text-slate-700 leading-relaxed mb-4 text-base md:text-lg">
                  However, sudden involuntary distress—triggered by unanticipated private corporate downsizings, business supply-chain interruptions across Kanpur and Lucknow trading corridors, personal health crises, or post-retirement family obligations—has severely compromised the monthly debt-servicing capacity of thousands of families. When cash liquidity contracts, borrowers face multiple simultaneous equated monthly installment (EMI) defaults. In response, financial institutions frequently assign delinquent portfolios to aggressive third-party recovery agencies operating across Hazratganj, Aminabad, and Kanpur.
                </p>
                <p className="text-slate-700 leading-relaxed mb-4 text-base md:text-lg">
                  These recovery agencies routinely deploy coercive and unlawful collection tactics: persistent telephonic harassment outside permissible hours, threats of workplace disclosure in government offices and corporate parks, unannounced visits to residential colonies in Aliganj, Indira Nagar, Ashiyana, and Gomti Nagar, and intimidation regarding imminent police arrests. Distressed borrowers must understand that such intimidatory practices directly violate Reserve Bank of India directives, and established legal procedures exist to permanently halt harassment and achieve substantial debt reduction through structured compromise settlements.
                </p>
                <div className="bg-amber-50 border-l-4 border-amber-500 p-5 rounded-r-xl my-6">
                  <div className="flex items-start gap-3">
                    <AlertCircle className="w-5 h-5 text-amber-600 flex-shrink-0 mt-0.5" />
                    <div className="text-xs sm:text-sm text-amber-900 leading-relaxed">
                      <strong>Statutory Legal Reality in Uttar Pradesh:</strong> Involuntary financial default resulting from genuine economic hardship is recognized under Indian jurisprudence strictly as a civil breach of contract governed by the Indian Contract Act, 1872. It does not constitute a criminal offense. Neither outsourced recovery agents nor bank representatives possess any legal authority to summon you to local police stations or execute arrests for unpaid unsecured loans.
                    </div>
                  </div>
                </div>
              </section>

              {/* Section 2: Delinquency Timeline & Allahabad HC Jurisprudence */}
              <section id="npa-timeline-allahabad-hc-jurisprudence" className="scroll-mt-24 mb-12">
                <div className="inline-flex items-center gap-2 text-xs font-bold text-[#1F5EFF] uppercase tracking-wider mb-2">
                ...
                <p className="text-slate-700 leading-relaxed mb-4 text-base md:text-lg">
                  During the first 90 days of overdue status, the account is categorized as a Special Mention Account (SMA-0 for 1–30 days, SMA-1 for 31–60 days, and SMA-2 for 61–90 days). Once the overdue duration crosses the 90-day threshold without clearance, the lending institution is mandated under RBI regulations to classify the account as a Non-Performing Asset (NPA). Upon NPA classification, the bank must set aside statutory capital provisions from its operational profits (ranging from 15% to 25% for Substandard assets, 40% to 100% for Doubtful assets, and 100% for Loss assets).
                </p>
                  ...
                  <table className="min-w-full bg-white">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>Automated SMS notices, collection calling, mandate bounce fees. Substantive debt waivers unavailable.</td>
                      </tr>
                      <tr>
                        <td className="font-semibold text-slate-900">SMA-2</td>
                        <td>61 – 90 Days Overdue</td>
                        <td>Pre-NPA Watchlist</td>
                        <td>Pre-NPA demand notices issued, recovery agency escalation. EMI restructuring or tenure extension possible.</td>
                      </tr>
                      <tr>
                        <td className="font-semibold text-slate-900">Substandard NPA</td>
                        <td>91 – 365 Days Overdue</td>
                        <td>15% – 25% Profit Provision</td>
                        <td>Account transferred to Zonal SARB desks in Hazratganj/Vibhuti Khand. 35%–50% principal haircuts become viable.</td>
                      </tr>
                      <tr>
                        <td className="font-semibold text-slate-900">Doubtful (D1 / D2)</td>
                        <td>1 – 3 Years Overdue</td>
                        <td>40% – 100% Capital Lock</td>
                        <td>Lenders prioritize balance sheet cleanup over legal delays. 50%–65% principal haircuts achievable.</td>
                      </tr>
                      <tr>
              ...
              <section id="statutory-notices-kaisarbagh-defense" className="scroll-mt-24 mb-12">
                ...
                <p className="text-slate-700 leading-relaxed mb-4 text-base md:text-lg">
                  Receiving a statutory legal notice demands prompt, professional advocate intervention. Under the law, a borrower is entitled to a mandatory <strong>15-day statutory response window</strong> from the date of service. Disregarding a statutory notice allows the lender to file a formal complaint under Section 142 of the NI Act, resulting in judicial summons and potential bailable warrants if left unrepresented.
                </p>
                <p className="text-slate-700 leading-relaxed mb-4 text-base md:text-lg">
                  A seasoned debt defense advocate drafts a comprehensive legal reply within the 15-day window. The reply formally places on record: (a) The complete absence of dishonest intent or fraudulent mens rea at loan inception; (b) Documented proof of involuntary financial hardship (such as medical records, salary reductions, corporate layoff documentation, or certified business balance sheets); (c) Substantive legal objections challenging inflated compound interest, unnotified penalty levies, and unlawful bounce charges; (d) A bona fide proposal for amicable compromise resolution under RBI master guidelines.
                </p>
                <p className="text-slate-700 leading-relaxed text-base md:text-lg">
                  Placing an assertive legal defense on record fundamentally alters the bank&apos;s recovery calculus. Because prosecuting a complaint through crowded magistrate courts in Kaisarbagh entails years of procedural hearings, advocate fees, and witness testimonies, bank legal officers routinely prefer directing accounts with structured advocate replies toward the Zonal Stressed Assets Recovery Branch or the National Lok Adalat for an expedited compromise settlement.
                </p>
              </section>

              {/* Section 4: Banker's Right of General Lien (Section 171) & UP Salary Shielding */}
              <section id="bankers-lien-up-salary-shielding" className="scroll-mt-24 mb-12">
                <div className="inline-flex items-center gap-2 text-xs font-bold text-[#1F5EFF] uppercase tracking-wider mb-2">
                ...
                <p className="text-slate-700 leading-relaxed mb-4 text-base md:text-lg">
                  For example, if a borrower defaults on an unsecured personal loan with State Bank of India, Punjab National Bank, or HDFC Bank while maintaining their active UP Cyber Treasury salary account or operational savings with the same institution, the bank&apos;s core banking system can automatically sweep incoming salary credits upon an EMI default. This sudden appropriation can leave a family without essential funds for food, rent, utility bills, or emergency medical care.
                </p>
                <p className="text-slate-700 leading-relaxed mb-4 text-base md:text-lg">
              ...
              <section id="infographic-resolution-blueprint" className="scroll-mt-24 mb-12">
                ...
                <div className="relative rounded-2xl overflow-hidden border border-slate-200 shadow-lg my-8 bg-slate-900">
                  <img
                      width={1200}
                      height={675}
                    src="/images/infographics/personal-loan-settlement-lucknow.jpg"
                    alt="Personal Loan Settlement Process in Lucknow and Uttar Pradesh Resolution Roadmap"
                    className="w-full h-auto object-cover"
                  />
                  <div className="p-4 bg-slate-900/90 border-t border-slate-800 text-center">
                    <p className="text-xs text-slate-300 font-medium">
                      Figure 1.0: End-to-End Lucknow Personal Loan Settlement Framework, Court Notice Defense &amp; Zonal SARB Resolution Protocol.
                    </p>
                  </div>
                </div>
              </section>
              ...
              {/* Section 7: Anti-Harassment Protections & Enforcing RBI Guidelines in UP */}
              <section id="anti-harassment-up-police-boundaries" className="scroll-mt-24 mb-12">
                <div className="inline-flex items-center gap-2 text-xs font-bold text-[#1F5EFF] uppercase tracking-wider mb-2">
                ...
                <p className="text-slate-700 leading-relaxed mb-4 text-base md:text-lg">
                  Furthermore, recovery agents frequently threaten to lodge criminal complaints with local police stations in Hazratganj, Gomti Nagar, or Kanpur. Under Supreme Court rulings in <em>Arnesh Kumar v. State of Bihar</em> and <em>Lalita Kumari v. Government of UP</em>, police officers cannot entertain commercial debt complaints or issue informal police station call letters for civil loan defaults.
                </p>
                <p className="text-slate-700 leading-relaxed text-base md:text-lg">
                  When collection agencies breach these mandatory norms, our legal team dispatches formal cease-and-desist notices to the lending institution&apos;s Principal Nodal Officer and Board of Directors, while simultaneously filing complaints with the <strong>Lucknow Police Commissionerate</strong>, the Cyber Crime Cell, and the <strong>RBI Integrated Ombudsman Portal (CMS)</strong>. Faced with regulatory exposure, lenders promptly order collection agencies to cease all direct contact.
                </p>
              </section>

              {/* Section 8: 5-Step SARB Settlement Protocol in Lucknow */}
              <section id="advocate-settlement-roadmap-lucknow" className="scroll-mt-24 mb-12">
                <div className="inline-flex items-center gap-2 text-xs font-bold text-[#1F5EFF] uppercase tracking-wider mb-2">
              ...
              <section id="comparative-resolution-matrix" className="scroll-mt-24 mb-12">
                ...
                <div className="overflow-x-auto my-6">
                  <table className="min-w-full bg-white">
                    ...
                    <tbody>
                      <tr>
                        <td className="font-semibold text-slate-900">Direct Zonal SARB Settlement (Lucknow)</td>
                      ...
                      <tr>
                        <td className="font-semibold text-slate-900">UP State Lok Adalat (UPSLSA Kaisarbagh)</td>
                      ...
                      <tr>
                        <td className="font-semibold text-slate-900">Civil Court Litigation (Kaisarbagh / HC)</td>
            ...
            <aside className="w-full sticky top-24 space-y-6">
              ...
              <div className="bg-gradient-to-br from-slate-900 to-slate-800 text-white rounded-2xl p-5 shadow-md border border-slate-700">
                <div className="flex items-center gap-2 text-blue-400 font-bold text-xs uppercase tracking-wider mb-2">
                  ...
                  <span>Lucknow Legal Defense</span>
                </div>
                <div className="font-bold text-base text-white mb-2">Facing Recovery Pressure in Lucknow?</div>
                <p className="text-xs text-slate-300 leading-relaxed mb-4">
                  Halt recovery agent harassment, defend against Kaisarbagh court notices, protect your salary account, and negotiate 40%–70% debt waivers directly with SARB zonal committees.
                </p>
                <Link
                  href="/contact"
