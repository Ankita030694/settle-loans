...
export const metadata: Metadata = {
  ...
  description: "Comprehensive guide to RBI rules for recovery agents in 2026. Learn about 8 AM-7 PM timing, certification requirements, and how to stop illegal harassment.",
  alternates: {
