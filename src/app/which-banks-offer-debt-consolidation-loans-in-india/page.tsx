      ...
      <div className="w-full mx-auto px-4 md:px-8 lg:px-12 py-16 flex flex-col lg:flex-row gap-12 relative">
        ...
        <article className="w-full lg:w-3/5 flex-1 max-w-none font-sans text-[var(--color-text-body)]">
          ...
          <section id="top-banks" className="scroll-mt-32 mb-16">
            <h3 className="text-3xl md:text-4xl font-black text-[#2E2E2E] mb-6 uppercase tracking-tight">The Big Four: Top Indian Banks</h3>
            <div className="space-y-12">
              <div className="bg-white border-l-4 border-[#1F5EFF] p-8 rounded-r-2xl shadow-sm border border-[#DEDEDE]">
                 <h4 className="text-2xl font-black mb-4">1. HDFC Bank: The Market Leader</h4>
              ...
              <div className="bg-white border-l-4 border-[#1F5EFF] p-8 rounded-r-2xl shadow-sm border border-[#DEDEDE]">
                 <h4 className="text-2xl font-black mb-4">2. State Bank of India (SBI): The Lowest Cost</h4>
              ...
              <div className="bg-white border-l-4 border-[#1F5EFF] p-8 rounded-r-2xl shadow-sm border border-[#DEDEDE]">
                 <h4 className="text-2xl font-black mb-4">3. ICICI Bank: Flexible Repayment</h4>
               ...
               <div className="bg-white border-l-4 border-[#1F5EFF] p-8 rounded-r-2xl shadow-sm border border-[#DEDEDE]">
                 <h4 className="text-2xl font-black mb-4">4. Axis Bank: Quick Digital Disbursement</h4>
          ...
          <section id="nbfc-options" className="scroll-mt-32 mb-16">
             <h3 className="text-3xl md:text-4xl font-black text-[#2E2E2E] mb-6">NBFCs: For Faster and More Relaxed Approvals</h3>
             ...
             <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="p-8 bg-gray-50 rounded-2xl border border-[#DEDEDE]">
                   <h5 className="font-black text-xl mb-3">Tata Capital</h5>
          ...
          <section id="eligibility" className="scroll-mt-32 mb-16">
            <h3 className="text-3xl md:text-4xl font-black text-[#2E2E2E] mb-6">Eligibility: What do you need?</h3>
          ...
          <section id="benefits" className="scroll-mt-32 mb-16">
            <h3 className="text-3xl md:text-4xl font-black text-[#2E2E2E] mb-6 tracking-tight">Key Benefits of Consolidation</h3>
          ...
          <section id="how-it-works" className="scroll-mt-32 mb-16">
            <h3 className="text-3xl md:text-4xl font-black text-[#2E2E2E] mb-6">How the Process Works</h3>
            <p className="text-lg leading-relaxed mb-6">
            ...
            <div className="relative pl-10 border-l-2 border-[#1F5EFF]/30 space-y-12 my-12">
               ...
               <div className="relative">
                  ...
                  <h5 className="font-black text-xl mb-2">The Application</h5>
               ...
               <div className="relative">
                  ...
                  <h5 className="font-black text-xl mb-2">Direct Payment</h5>
               ...
               <div className="relative">
                  ...
                  <h5 className="font-black text-xl mb-2">Closing Confirmation</h5>
          ...
          <section id="secured-consolidation" className="scroll-mt-32 mb-16">
            <h3 className="text-3xl md:text-4xl font-black text-[#2E2E2E] mb-6 tracking-tight">Secured Consolidation: If your Score is Low</h3>
            <p className="text-lg leading-relaxed mb-6">
            ...
            <div className="bg-[#2E2E2E] rounded-3xl p-10 text-white relative overflow-hidden group">
               ...
               <h4 className="text-2xl font-black mb-6 relative z-10 text-[#DEDEDE]">The "Property Strategy"</h4>
          ...
          <section id="settlement-alt" className="scroll-mt-32 mb-16">
            <h3 className="text-3xl md:text-4xl font-black text-[#2E2E2E] mb-6">Consolidation vs. Settlement: The Choice</h3>
            <p className="text-lg leading-relaxed mb-6">
            ...
            <div className="flex flex-col md:flex-row gap-6 my-8">
               ...
               <div className="flex-1 p-6 bg-emerald-50 border border-emerald-100 rounded-2xl">
                  <h5 className="font-black text-emerald-800 mb-4">Debt Settlement</h5>
          ...
          <section id="faqs" className="scroll-mt-32 mb-16">
            <h3 className="text-3xl md:text-4xl font-black text-[#2E2E2E] mb-8 text-center uppercase tracking-tighter">Market FAQs 2026</h3>
          ...
          <section className="scroll-mt-32 mb-16">
             <div className="bg-[#1F5EFF] p-12 rounded-[50px] text-center text-white relative overflow-hidden group shadow-2xl">
                ...
                <h4 className="text-2xl md:text-5xl font-black mb-8">Ready to Simplify <br/>Your Financial Life?</h4>
