...
export const metadata: Metadata = {
  ...
  keywords: [
    'personal loan settlement lawyer in jodhpur',
    'loan settlement advocate jodhpur',
    'debt settlement lawyers jodhpur',
    'personal loan settlement jodhpur',
    'rajasthan high court jodhpur debt lawyer',
    'paota district court loan default advocate',
    'cjm jodhpur section 138 bounce lawyer',
    'rslsa lok adalat jodhpur loan settlement',
    'bank recovery harassment advocate jodhpur',
    'one time settlement ots jodhpur banks',
    'handicraft exporter debt settlement jodhpur',
    'solar contractor loan settlement jodhpur',
  ],
  alternates: {
  ...
  openGraph: {
    ...
    images: [
      {
        url: 'https://www.settleloans.in/images/infographics/personal-loan-settlement-jodhpur.jpg',
        width: 1200,
        height: 675,
        alt: 'Personal Loan Settlement Lawyer in Jodhpur Legal Defense Guide',
      },
    ],
    locale: 'en_IN',
    type: 'article',
...
const jsonLdGraph = {
  ...
  "@graph": [
    {
      "@type": "WebPage",
      "@id": "https://www.settleloans.in/personal-loan-settlement-jodhpur#webpage",
      "url": "https://www.settleloans.in/personal-loan-settlement-jodhpur",
      "name": "Personal Loan Settlement Lawyer in Jodhpur: Legal Defense & OTS Advocates",
      "description": "Facing personal loan default, recovery harassment, or court notices in Jodhpur, Pali, or Bikaner? Experienced debt settlement lawyers provide Rajasthan High Court defense, salary protection, and 40%–70% OTS waivers.",
      "breadcrumb": {
        "@id": "https://www.settleloans.in/personal-loan-settlement-jodhpur#breadcrumb"
      },
      "inLanguage": "en-IN",
      "isPartOf": {
        "@type": "WebSite",
    ...
    },
    {
      ...
      "itemListElement": [
        ...
        },
        {
          "@type": "ListItem",
          "position": 3,
          "name": "Personal Loan Settlement Lawyer in Jodhpur",
          "item": "https://www.settleloans.in/personal-loan-settlement-jodhpur"
        }
      ]
    },
    {
      "@type": "Article",
      "@id": "https://www.settleloans.in/personal-loan-settlement-jodhpur#article",
      "headline": "Personal Loan Settlement Lawyer in Jodhpur: High Court Seat Legal Defense & 40%–70% Bank OTS Waivers",
      "description": "Comprehensive legal and financial analysis for distressed handicraft exporters, solar contractors, traders, and salaried professionals in Jodhpur. Explore Paota District Court dynamics, Rajasthan High Court civil debt protections, Section 171 banker lien limits, and advocate-led OTS negotiations yielding 40% to 70% debt waivers.",
      "image": "https://www.settleloans.in/images/infographics/personal-loan-settlement-jodhpur.jpg",
      "datePublished": "2026-09-03T11:30:00+05:30",
      "dateModified": "2026-09-03T11:30:00+05:30",
      "mainEntityOfPage": {
        "@type": "WebPage",
        "@id": "https://www.settleloans.in/personal-loan-settlement-jodhpur#webpage"
      },
    ...
    {
      "@type": "FAQPage",
      "@id": "https://www.settleloans.in/personal-loan-settlement-jodhpur#faq",
      "mainEntity": [
        {
          "@type": "Question",
    ...
    },
    {
      ...
      "@id": "https://www.settleloans.in/personal-loan-settlement-jodhpur#service",
      "name": "SettleLoans - Personal Loan Settlement Lawyer in Jodhpur & Legal Defense",
      "description": "Specialized debt settlement representation, High Court and District Court notice defense, and bank One-Time Settlement (OTS) advisory for handicraft exporters, solar contractors, traders, and salaried professionals across Jodhpur, Pali, and Bikaner.",
      "url": "https://www.settleloans.in/personal-loan-settlement-jodhpur",
      "image": "https://www.settleloans.in/images/infographics/personal-loan-settlement-jodhpur.jpg",
      ...
      "address": {
        "@type": "PostalAddress",
        "streetAddress": "Paota / High Court Road, Sardarpura",
...
const tocItems = [
  { id: "jodhpur-western-rajasthan-debt-realities", title: "1. Jodhpur & Western Rajasthan Debt Realities" },
  { id: "npa-timeline-rajasthan-high-court-jurisprudence", title: "2. Delinquency Timeline & High Court Jurisprudence" },
  { id: "paota-district-court-notice-defense", title: "3. Paota District Court & Section 138/25 Defense" },
  { id: "bankers-lien-salary-shielding-jodhpur", title: "4. Section 171 Lien & Salary Shielding" },
  { id: "infographic-jodhpur-resolution-blueprint", title: "5. Visual Resolution Roadmap" },
  { id: "ots-haircut-mechanics-npv-benchmark", title: "6. OTS Haircut Mechanics & NPV Recovery Formula" },
  { id: "anti-harassment-jodhpur-police-boundaries", title: "7. Anti-Harassment & Police Limits in Jodhpur" },
  { id: "advocate-settlement-roadmap-jodhpur", title: "8. 5-Step Zonal SARB Settlement Protocol" },
        ...
        >
          ...
          <div className="max-w-4xl mx-auto text-center relative z-10">
            <div className="inline-flex items-center gap-2 py-1 px-3.5 rounded-full bg-blue-500/20 border border-blue-400/30 text-blue-300 text-xs font-black mb-3 tracking-wider uppercase">
              ...
              <span>Regional Debt Resolution • Jodhpur &amp; Western Rajasthan</span>
            </div>

            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-[38px] xl:text-[42px] font-black leading-tight tracking-tight text-white mb-5">Personal Loan Settlement in Jodhpur: Legal OTS Guide</h1>
            ...
            <div className="flex flex-wrap items-center justify-center gap-3">
              ...
              >
                <span>Consult Jodhpur Debt Advocate</span>
            ...
            <main className="w-full min-w-0 blog-content">
              ...
              <div className="bg-gradient-to-br from-blue-50 to-indigo-50/70 border border-blue-200 rounded-2xl p-6 mb-8 shadow-sm">
                <div className="flex items-center gap-2 text-blue-900 font-bold text-base mb-3">
                  ...
                  <span>Key Takeaways: Debt Settlement in Jodhpur &amp; Western Rajasthan</span>
                </div>
              ...
              {/* Section 1: Regional Debt Realities in Jodhpur & Western Rajasthan */}
              <section id="jodhpur-western-rajasthan-debt-realities" className="scroll-mt-24 mb-12">
              ...
              <section id="npa-timeline-rajasthan-high-court-jurisprudence" className="scroll-mt-24 mb-12">
                <div className="inline-flex items-center gap-2 text-xs font-bold text-[#1F5EFF] uppercase tracking-wider mb-2">
              ...
              <section id="bankers-lien-salary-shielding-jodhpur" className="scroll-mt-24 mb-12">
                <div className="inline-flex items-center gap-2 text-xs font-bold text-[#1F5EFF] uppercase tracking-wider mb-2">
              ...
              <section id="infographic-jodhpur-resolution-blueprint" className="scroll-mt-24 mb-12">
                <div className="inline-flex items-center gap-2 text-xs font-bold text-[#1F5EFF] uppercase tracking-wider mb-2">
              ...
              {/* Section 7: Anti-Harassment Safeguards & Jodhpur Police Boundaries */}
              <section id="anti-harassment-jodhpur-police-boundaries" className="scroll-mt-24 mb-12">
                <div className="inline-flex items-center gap-2 text-xs font-bold text-[#1F5EFF] uppercase tracking-wider mb-2">
              ...
              {/* Section 8: 5-Step SARB Settlement Protocol in Jodhpur */}
              <section id="advocate-settlement-roadmap-jodhpur" className="scroll-mt-24 mb-12">
                <div className="inline-flex items-center gap-2 text-xs font-bold text-[#1F5EFF] uppercase tracking-wider mb-2">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="bg-slate-50 border border-slate-200 rounded-2xl p-6">
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      <div className="font-bold text-slate-900 text-base">Metropolitan Sessions Court Jodhpur</div>
                    </div>
                    <p className="text-sm text-slate-600 leading-relaxed mb-3">
                      <strong>Address:</strong> Paota Circle, High Court Colony, Jodhpur, Rajasthan - 342006
                    </p>
                    <p className="text-xs text-slate-500 leading-relaxed">
                      <strong>Jurisdiction:</strong> Adjudicates Section 138 NI Act cases, commercial dispute suits, and recovery agent injunctions for handicraft exporters and local retail borrowers.
                    </p>
                  </div>
                  <div className="bg-slate-50 border border-slate-200 rounded-2xl p-6">
                    <div className="flex items-center gap-3 mb-3">
                      <Scale className="w-5 h-5 text-[#1F5EFF]" />
                      <div className="font-bold text-slate-900 text-base">District Legal Services Authority (DLSA) Jodhpur Metro</div>
                    </div>
                    <p className="text-sm text-slate-600 leading-relaxed mb-3">
                      <strong>Address:</strong> ADR Centre, Old Rajasthan High Court Campus, Paota, Jodhpur - 342006
                    </p>
                    <p className="text-xs text-slate-500 leading-relaxed">
                      <strong>Lok Adalat Conciliation:</strong> Coordinates National Lok Adalat reconciliation panels for unsecured bank loans, issuing court decrees that permanently close default files.
                    </p>
                  </div>
                </div>
              </section>
            ...
            <aside className="w-full sticky top-24 space-y-6">
              ...
              <div className="bg-gradient-to-br from-slate-900 to-slate-800 text-white rounded-2xl p-5 shadow-md border border-slate-700">
                <div className="flex items-center gap-2 text-blue-400 font-bold text-xs uppercase tracking-wider mb-2">
                  ...
                  <span>Jodhpur Legal Defense</span>
                </div>
