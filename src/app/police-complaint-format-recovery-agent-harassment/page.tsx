      ...
      >
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-[38px] xl:text-[42px] font-black leading-tight tracking-tight text-white mb-5">
            Police Complaint Against Recovery Agent Harassment: <span className="text-[#3b82f6] md:text-[#60a5fa]">Format</span>
          </h1>
          ...
          <main className="w-full blog-content space-y-10 min-w-0">
            ...
            <section className="border-t border-slate-200 pt-8 mb-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 text-xs">
                ...
                <span className="font-semibold text-slate-800 underline decoration-slate-300"><span className="font-semibold text-slate-800">Indian Penal Code, 1860 (Sections 506, 509, 383 &amp; 441)</span></span>
                <a
