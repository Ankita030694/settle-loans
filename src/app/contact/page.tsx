        ...
        <section className="py-16 px-4 md:px-8 max-w-7xl mx-auto w-full">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            ...
            <div className="p-8 rounded-2xl bg-gray-50 border border-gray-100 flex flex-col items-center text-center">
              ...
              <h4 className="text-xl font-bold text-gray-900 mb-2">Advisory Hours</h4>
            ...
            <div className="p-8 rounded-2xl bg-gray-50 border border-gray-100 flex flex-col items-center text-center">
              ...
              <h4 className="text-xl font-bold text-gray-900 mb-2">Harassment Hotline</h4>
          ...
          <div className="max-w-4xl mx-auto space-y-12 text-gray-800">
            <div>
              <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">What to Expect During Your Free Consultation</h3>
            ...
            <div className="border-t border-gray-200 pt-8">
              ...
              <div className="space-y-6">
                <div>
                  <h4 className="text-lg font-semibold text-gray-900 mb-2">1. Is my financial information kept confidential?</h4>
                ...
                <div>
                  <h4 className="text-lg font-semibold text-gray-900 mb-2">2. What documents should I have ready before speaking with an advocate?</h4>
                  <p className="text-gray-600 leading-relaxed">
                ...
                <div>
                  <h4 className="text-lg font-semibold text-gray-900 mb-2">3. How quickly can SettleLoans intervene if recovery agents visit my home?</h4>
                  <p className="text-gray-600 leading-relaxed">
                ...
                <div>
                  <h4 className="text-lg font-semibold text-gray-900 mb-2">4. What happens immediately after I submit this consultation form?</h4>
                  <p className="text-gray-600 leading-relaxed">
                ...
                <div>
                  <h4 className="text-lg font-semibold text-gray-900 mb-2">5. Can I schedule an emergency consultation outside business hours?</h4>
                  <p className="text-gray-600 leading-relaxed">
