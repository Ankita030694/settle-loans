...
export const metadata: Metadata = {
  ...
  description: "Book a free consultation for loan settlement to understand your rights and options. Stop harassment & settle debt legally with SettleLoans.",
  alternates: {
...
export default function FreeConsultationPage() {
  const jsonLd = {
    ...
    "@graph": [
      {
        "@type": "WebPage",
        "@id": "https://www.settleloans.in/faqs/free-consultation-loan-settlement#webpage",
        ...
        "breadcrumb": { "@id": "https://www.settleloans.in/faqs/free-consultation-loan-settlement#breadcrumb" },
        "inLanguage": "en-IN"
      },
      {
        "@type": "BreadcrumbList",
        "@id": "https://www.settleloans.in/faqs/free-consultation-loan-settlement#breadcrumb",
        "itemListElement": [
          {
            "@type": "ListItem",
            "position": 1,
          ...
          },
          {
            ...
            "item": "https://www.settleloans.in/faqs/free-consultation-loan-settlement"
          }
        ]
      },
      {
        "@type": "Product",
        "@id": "https://www.settleloans.in/faqs/free-consultation-loan-settlement#service",
        ...
        "review": [
          ...
          {
            "@type": "Review",
            "author": { "@type": "Person", "name": "Ramesh V." },
            "datePublished": "2024-12-12",
            "reviewBody": "Clear legal advice on how to handle ICICI recovery agents. The strategy session gave me the confidence to face my debt.",
            "reviewRating": { "@type": "Rating", "ratingValue": "5" }
          },
          {
            "@type": "Review",
            ...
            "reviewBody": "They identified my job loss as a genuine hardship. The roadmap to settlement was very clear and realistic.",
            "reviewRating": { "@type": "Rating", "ratingValue": "5" }
          },
          {
            "@type": "Review",
            ...
            "reviewBody": "Honest assessment. They didn't promise miracles but gave me a solid legal plan to stop the harassment.",
            "reviewRating": { "@type": "Rating", "ratingValue": "5" }
          }
        ],
        "serviceType": "Financial Consultancy",
        "areaServed": "India",
        "isSimilarTo": "https://www.settleloans.in/faqs/eligibility-checker-for-loan-settlement"
      }
    ]
  };
        ...
        <section className="w-full bg-[#2E2E2E] pt-24 pb-12 md:pt-40 md:pb-24 px-4 md:px-8 lg:px-16 relative overflow-hidden min-h-[400px] md:min-h-[500px] flex flex-col justify-center">
          ...
          <div className="max-w-5xl mx-auto text-center relative z-10">
            ...
            <p className="text-base md:text-2xl text-[#DEDEDE]/80 mb-10 max-w-3xl mx-auto leading-[1.2] font-normal">
              Stop guessing and start solving. Our specialized legal & financial experts are ready to analyze your case and provide a roadmap to becoming debt-free.
            </p>
              ...
              {[
                {
                  name: "Alok Nath",
                  loc: "Pune",
                  loan: "HSBC Personal Loan: ₹6L",
                  res: "Strategy: 55% Waiver",
                  story: "The free consultation was a eye-opener. I finally understood my legal rights as a borrower. No pressure, just pure value."
                },
                {
                  name: "Ramesh V.",
                  loc: "Chennai",
                  loan: "ICICI Personal Loan: ₹5L",
                  res: "Strategy: 60% Waiver",
                  story: "Clear legal advice on how to handle ICICI recovery agents. The strategy session gave me the confidence to face my debt."
                },
                {
                  name: "Sneha K.",
                  loc: "Mumbai",
                  loan: "SBI Personal Loan: ₹3L",
                  res: "Strategy: 50% Waiver",
                  story: "They identified my job loss as a genuine hardship. The roadmap to settlement was very clear and realistic."
                },
                {
                  name: "Michael D.",
                  loc: "Kochi",
                  loan: "HDFC Personal Loan: ₹10L",
                  res: "Strategy: 65% Waiver",
                  story: "Honest assessment. They didn't promise miracles but gave me a solid legal plan to stop the harassment."
                }
              ].map((review, i) => (
              ...
              <div className="space-y-4 not-prose">
                {[
                  ...
                  <details key={i} className="group bg-white border border-gray-200 rounded-xl overflow-hidden hover:shadow-md transition-all">
                    ...
                    <div className="px-5 pb-5 text-lg opacity-90 leading-relaxed border-t border-gray-100 pt-4 mt-0 bg-gray-50/50">
                      {faq.a}
                    </div>
                  </details>
                ))}
            ...
            <div className="sticky top-24 space-y-8">
              ...
              <div className="bg-[#2E2E2E] rounded-2xl shadow-xl overflow-hidden border border-[#DEDEDE]/10 group">
                ...
                <div className="p-8 text-center">
                  ...
                  <p className="mt-4 text-xs text-[#DEDEDE]/50"> Limited Slots Daily</p>
                </div>
              </div>
