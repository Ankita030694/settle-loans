...
export const metadata: Metadata = {
    ...
    description: "Get verified contact details, phone numbers, and addresses for India's leading debt resolution companies including SettleLoans, AMA Legal, and Freed.",
    alternates: {
