...
export const metadata: Metadata = {
  ...
  description: 'Learn how to settle your loan legally in India. Step-by-step guide on debt negotiation, RBI guidelines, Lok Adalat, and credit repair.',
  alternates: {
          ...
          <aside className="hidden lg:block w-[20%] border-l border-[#DEDEDE] bg-gray-50/10">
            <div className="sticky top-24 p-6 space-y-8">
              ...
              <div className="bg-white p-6 rounded-2xl border border-[#DEDEDE] shadow-sm">
                 <div className="text-sm font-black uppercase tracking-wider text-[#747474] mb-4 border-b border-[#DEDEDE] pb-2">Why Choose Us</div>
