                ...
                <div className="w-full mx-auto px-4 md:px-8 lg:px-12 py-16 flex flex-col lg:flex-row gap-12 relative">
                    ...
                    <article className="w-full lg:w-3/5 flex-1 max-w-none font-sans text-[var(--color-text-body)]">
                        ...
                        <section id="top-companies" className="scroll-mt-32 mb-16">
                            ...
                            <div className="space-y-4">
                                {[
                                    ...
                                    { rank: 2, name: <Link href="https://amalegalsolutions.com" target="_blank" rel="noopener noreferrer" className="text-[#1F5EFF] hover:underline">AMA Legal Solutions</Link>, focus: "High-Value / Guidance", score: "4.7/5", desc: "Specializes in high-ticket personal loans where legal defense is required alongside negotiation." },
                        ...
                        <div className="mt-16 pt-8 border-t border-[var(--color-border)] text-center text-[var(--color-text-muted)] text-sm italic mb-16">
                            <p>Disclaimer: Personal loan settlement is a mutual compromise between lender and borrower. <Link href="https://amalegalsolutions.com" target="_blank" rel="noopener noreferrer" className="text-[#1F5EFF] hover:underline">SettleLoans</Link> is an independent consultancy. We do not provide loans or legal representation directly in court. Settlement results vary based on bank policy and individual case details.</p>
                        </div>
