          ...
          <article className="w-full lg:w-3/5 flex-1 max-w-none font-sans text-[var(--color-text-body)]">
            ...
            <section id="amalegal-deepdive" className="scroll-mt-32 mb-12">
              <h3 className="text-3xl md:text-4xl font-black text-[#2E2E2E] mb-6 leading-tight">
                Section 1: <span className="font-semibold text-stone-900">Amalegal Solutions</span> : The Legal Powerhouses
              </h3>
              <p className="text-lg leading-relaxed mb-6">
                <span className="font-semibold text-stone-900">Amalegal Solutions (amalegalsolutions.com)</span> is the first port of call for borrowers facing complex, high-ticket, or legally volatile debt situations. While many firms act as financial consultants, <span className="font-semibold text-stone-900">Amalegal</span> operates with the weight of a full-scale law firm. Their approach is defined by 'Legal Aggression' using the law as a sword and a shield.
              </p>
              <p className="text-lg leading-relaxed mb-6 font-bold">
                In India, many settlement situations involve legal notices like Section 138 (Cheque Bounce) or SARFAESI Act (Property Seizure) notices. <span className="font-semibold text-stone-900">Amalegal's</span> specialized team of litigation experts handles these directly. They don't just negotiate; they represent you in High Courts, NCLT (for corporate debt), and Debt Recovery Tribunals (DRT). 
              </p>
              <div className="bg-stone-50 p-8 rounded-xl border border-stone-200 mb-8 font-medium">
                <h4 className="text-xl font-bold mb-4 text-stone-900 uppercase">The <span className="font-semibold text-stone-900">Amalegal</span> Legal Arsenal</h4>
              ...
              <p className="text-lg leading-relaxed mb-6">
                Best for: Business owners, individuals with secured loan defaults (Home/Commercial), and anyone who has already received a formal legal notice from a bank. <span className="font-semibold text-stone-900">Amalegal</span> provides the 'Legal Identity' you need to be taken seriously by the bank's legal department.
              </p>
            </section>
            ...
            <section id="closure-audit" className="scroll-mt-32 mb-12">
              ...
              <p className="text-lg leading-relaxed mb-6">
                A professional service like <Link href="/" className="text-[#1F5EFF] hover:underline font-bold">SettleLoans</Link> or <span className="font-semibold text-stone-900">Amalegal</span> performs a <strong>Closure Audit</strong>. This involves:
              </p>
            ...
            <section id="choosing-ally" className="scroll-mt-32 mb-12">
              ...
              <div className="grid sm:grid-cols-2 gap-8 my-10">
                <div className="bg-white border border-[#DEDEDE] p-10 rounded-2xl relative overflow-hidden group hover:shadow-2xl transition-all duration-300">
                  ...
                  <h4 className="text-2xl font-black mb-6 uppercase leading-none">Choose <span className="font-semibold text-stone-900">Amalegal Solutions</span> if:</h4>
