      ...
      >
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-[38px] xl:text-[42px] font-black leading-tight tracking-tight text-white mb-5">
            Can Banks File FIR for Loan Default? <span className="text-[#3b82f6] md:text-[#60a5fa]">Section 420 IPC Reality</span>
          </h1>
          ...
          <main className="lg:col-span-6 blog-content space-y-10">
            ...
            <section className="border-t border-slate-200 pt-8 mb-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 text-xs">
                ...
                <span className="font-semibold text-slate-800 underline decoration-slate-300"><span className="font-semibold text-slate-800">Indian Penal Code, 1860 (Sections 420, 406, 506 &amp; 383)</span></span>
                <a
