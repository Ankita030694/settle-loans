      ...
      <main className="flex-grow w-full bg-white selection:bg-[#1F5EFF] selection:text-white" style={{ fontFamily: 'var(--font-satoshi), Satoshi, sans-serif' }}>
          ...
          <article className="w-full lg:w-3/5 flex-1 max-w-none font-sans text-[#2E2E2E]">
            ...
            <section id="unique-challenges" className="scroll-mt-32 mb-12">
              ...
              <div className="bg-gray-50 p-8 rounded-xl border border-gray-200 mb-8">
                <h4 className="text-xl font-bold mb-6">Are You in a Business Debt Trap? Check the Signs:</h4>
            ...
            <section id="settlement-definition" className="scroll-mt-32 mb-12">
              ...
              <div className="bg-blue-50 p-8 rounded-xl border border-blue-200 mb-8">
                <h4 className="text-xl font-bold mb-4 text-blue-900 text-[var(--color-text-body)]">The Hard Truth: Closure vs. Settlement</h4>
            ...
            <section id="loans-to-settle" className="scroll-mt-32 mb-12">
              ...
              <div className="space-y-6">
                <div className="bg-white p-6 rounded-2xl border border-[#DEDEDE] shadow-sm">
                  <h4 className="text-xl font-bold text-[#1F5EFF] mb-2">1. Unsecured Business Loans</h4>
                ...
                <div className="bg-white p-6 rounded-2xl border border-[#DEDEDE] shadow-sm">
                  <h4 className="text-xl font-bold text-[#1F5EFF] mb-2">2. Personal Loans used for Business</h4>
                ...
                <div className="bg-white p-6 rounded-2xl border border-[#DEDEDE] shadow-sm">
                  <h4 className="text-xl font-bold text-[#1F5EFF] mb-2">3. Credit Card Dues</h4>
                ...
                <div className="bg-white p-6 rounded-2xl border border-[#DEDEDE] shadow-sm">
                  <h4 className="text-xl font-bold text-[#1F5EFF] mb-2">4. Loan Against Property (LAP) / MSME Loans</h4>
            ...
            <section id="eligibility-criteria" className="scroll-mt-32 mb-12">
              <h3 className="text-3xl md:text-4xl font-black text-[#2E2E2E] mt-16 mb-8">Are You Eligible for a Settlement?</h3>
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-8">
                <div className="bg-orange-50/50 p-6 rounded-xl border border-orange-100">
                  <h4 className="text-xl font-bold text-orange-800 mb-3">Genuine Financial Distress</h4>
                ...
                <div className="bg-blue-50/50 p-6 rounded-xl border border-blue-100">
                  <h4 className="text-xl font-bold text-blue-800 mb-3">Non-Performing Asset (NPA) Status</h4>
            ...
            <section id="cibil-impact" className="scroll-mt-32 mb-12">
              <h3 className="text-3xl md:text-4xl font-black text-[#2E2E2E] mt-16 mb-8">The Hard Truth About CIBIL: Navigating the 'Settled' Remark</h3>
              ...
              <div className="bg-[#2E2E2E] text-white p-8 rounded-2xl mb-8">
                <h4 className="text-2xl font-bold mb-4">Why Settlement is Still Better Than Default</h4>
            ...
            <section id="step-by-step" className="scroll-mt-32 mb-12">
              <h3 className="text-3xl md:text-4xl font-black text-[#2E2E2E] mt-16 mb-8 text-center">The 7-Step Professional Settlement Roadmap</h3>
            ...
            <section id="required-docs" className="scroll-mt-32 mb-12">
              <h3 className="text-3xl md:text-4xl font-black text-[#2E2E2E] mt-16 mb-8">Documentation: The Key to Your Freedom</h3>
            ...
            <section id="legal-protections" className="scroll-mt-32 mb-12">
              <h3 className="text-3xl md:text-4xl font-black text-[#2E2E2E] mt-16 mb-8">Your Legal Protections: Knowledge is Power</h3>
              <p className="mb-6 text-lg">
              ...
              <div className="grid md:grid-cols-2 gap-8 mb-8">
                <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm">
                  <h4 className="text-xl font-bold mb-4">The MSME Samadhaan & RTI</h4>
                ...
                <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm">
                  <h4 className="text-xl font-bold mb-4">Civil Court & Mediation</h4>
                  <p className="text-sm text-gray-600 leading-relaxed mb-4">
            ...
            <section id="rbi-guidelines" className="scroll-mt-32 mb-12">
              ...
              <div className="bg-red-50 border-l-4 border-red-500 p-8 rounded-r-xl mb-8">
                <h4 className="text-xl font-bold text-red-800 mb-4">Strict Forbidden Practices for Agents:</h4>
            ...
            <section id="negotiation-tactics" className="scroll-mt-32 mb-12">
              <h3 className="text-3xl md:text-4xl font-black text-[#2E2E2E] mt-16 mb-8">Expert Negotiation Tactics: Get the Best Deal</h3>
              ...
              <div className="bg-blue-50 p-8 rounded-2xl border border-blue-100 mb-8">
                <h4 className="text-xl font-black text-blue-900 mb-6">The 'Power of Silence' Strategy</h4>
            ...
            <section id="case-studies" className="scroll-mt-32 mb-12">
              <h3 className="text-3xl md:text-4xl font-black text-[#2E2E2E] mt-16 mb-8 text-center">Real Stories of Business Revival</h3>
            ...
            <section id="why-settleloans" className="scroll-mt-32 mb-12">
              <h3 className="text-3xl md:text-4xl font-black text-[#2E2E2E] mt-16 mb-8">How SettleLoans Acts as Your Professional Buffer</h3>
              ...
              <div className="bg-[#2E2E2E] text-white p-8 rounded-2xl mb-8">
                <h4 className="text-2xl font-bold mb-4">Our Commitment to Self-Employed Clients</h4>
                <ul className="space-y-3 text-sm opacity-90">
        ...
        <section className="w-full bg-[#1F5EFF] py-16 px-4 md:px-8">
            <div className="max-w-4xl mx-auto text-center">
                <h3 className="text-3xl md:text-5xl font-black text-white mb-6">Ready to Reclaim Your Peace?</h3>
