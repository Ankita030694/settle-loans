            ...
            <div className="bg-white border border-gray-200 rounded-3xl p-8 mb-12 shadow-sm hover:shadow-md transition-all">
                <div className="flex flex-col md:flex-row gap-8 items-start">
                    ...
                    <div className="md:w-3/4">
                        ...
                        <Link href="https://amalegalsolutions.com" target="_blank" rel="noopener noreferrer" className="inline-flex items-center text-gray-900 font-black uppercase tracking-widest text-sm hover:underline">
