        ...
        <div className="w-full mt-12 pt-12 border-t border-gray-100">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-6 gap-y-3">
            {[
              ...
              { name: "Loan Foreclosure CIBIL Impact", href: "/does-foreclosure-of-loan-affect-cibil" },
              { name: "Debt Consolidation Loan Eligibility", href: "/debt-consolidation-loan-eligibility" },
              { name: "Bank Loan Settlement Rules", href: "/bank-loan-settlement-rules" },
              { name: "Bank Loan Settlement Guidelines", href: "/bank-loan-settlement-guidelines" },
              { name: "RBI July 2026 Recovery Guidelines", href: "/rbi-july-2026-recovery-guidelines" },
